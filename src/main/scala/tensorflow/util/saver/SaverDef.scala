...
final case class SaverDef(
                           ...
                           version: SaverDef.CheckpointFormatVersion = saver.SaverDef.CheckpointFormatVersion.LEGACY,
    ...
    def withVersion(__v: SaverDef.CheckpointFormatVersion): SaverDef = copy(version = __v)
    ...
    def companion: SaverDef.type = saver.SaverDef
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.SaverDef])
}

object SaverDef extends scalapb.GeneratedMessageCompanion[SaverDef] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[SaverDef] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): SaverDef = {
    ...
    var __version: SaverDef.CheckpointFormatVersion = saver.SaverDef.CheckpointFormatVersion.LEGACY
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 56 =>
          __version = saver.SaverDef.CheckpointFormatVersion.fromValue(_input__.readEnum())
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[SaverDef] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      SaverDef(
        ...
        version = saver.SaverDef.CheckpointFormatVersion.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(7).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(saver.SaverDef.CheckpointFormatVersion.LEGACY.scalaValueDescriptor).number)
      )
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 7 => saver.SaverDef.CheckpointFormatVersion
    }
  }
  lazy val defaultInstance = SaverDef(
    filenameTensorName = "",
    saveTensorName = "",
    restoreOpName = "",
    maxToKeep = 0,
    ...
    version = saver.SaverDef.CheckpointFormatVersion.LEGACY
  )
  ...
  sealed abstract class CheckpointFormatVersion(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    type EnumType = SaverDef.CheckpointFormatVersion
    type RecognizedType = SaverDef.CheckpointFormatVersion.Recognized
    def isLegacy: _root_.scala.Boolean = false
    def isV1: _root_.scala.Boolean = false
    def isV2: _root_.scala.Boolean = false
    def companion: _root_.scalapb.GeneratedEnumCompanion[CheckpointFormatVersion] = saver.SaverDef.CheckpointFormatVersion
    final def asRecognized: _root_.scala.Option[SaverDef.CheckpointFormatVersion.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[SaverDef.CheckpointFormatVersion.Recognized])
  }
  ...
  object CheckpointFormatVersion extends _root_.scalapb.GeneratedEnumCompanion[CheckpointFormatVersion] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = saver.SaverDef.javaDescriptor.getEnumTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = saver.SaverDef.scalaDescriptor.enums(0)
  }
  implicit class SaverDefLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, SaverDef]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, SaverDef](_l) {
    ...
    def version: _root_.scalapb.lenses.Lens[UpperPB, SaverDef.CheckpointFormatVersion] = field(_.version)((c_, f_) => c_.copy(version = f_))
  }
  ...
  def of(
    ...
    version: SaverDef.CheckpointFormatVersion
  ): SaverDef = SaverDef(
    filenameTensorName,
    saveTensorName,
    restoreOpName,
