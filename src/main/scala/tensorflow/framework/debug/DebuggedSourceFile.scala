...
final case class DebuggedSourceFile(
    ...
    def companion: DebuggedSourceFile.type = debug.DebuggedSourceFile
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.DebuggedSourceFile])
}

object DebuggedSourceFile extends scalapb.GeneratedMessageCompanion[DebuggedSourceFile] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[DebuggedSourceFile] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): DebuggedSourceFile = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[DebuggedSourceFile] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = DebuggedSourceFile(
    host = "",
    filePath = "",
    lastModified = 0L,
    bytes = 0L,
  ...
  implicit class DebuggedSourceFileLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, DebuggedSourceFile]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, DebuggedSourceFile](_l) {
