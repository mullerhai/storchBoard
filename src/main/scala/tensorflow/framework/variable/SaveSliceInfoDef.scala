...
final case class SaveSliceInfoDef(
    ...
    def companion: SaveSliceInfoDef.type = variable.SaveSliceInfoDef
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.SaveSliceInfoDef])
}

object SaveSliceInfoDef extends scalapb.GeneratedMessageCompanion[SaveSliceInfoDef] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[SaveSliceInfoDef] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): SaveSliceInfoDef = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[SaveSliceInfoDef] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = SaveSliceInfoDef(
    fullName = "",
    fullShape = _root_.scala.Seq.empty,
    varOffset = _root_.scala.Seq.empty,
    varShape = _root_.scala.Seq.empty
  )
  implicit class SaveSliceInfoDefLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, SaveSliceInfoDef]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, SaveSliceInfoDef](_l) {
