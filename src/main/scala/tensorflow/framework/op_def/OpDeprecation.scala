...
final case class OpDeprecation(
    ...
    def companion: OpDeprecation.type = op_def.OpDeprecation
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.OpDeprecation])
}

object OpDeprecation extends scalapb.GeneratedMessageCompanion[OpDeprecation] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[OpDeprecation] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): OpDeprecation = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[OpDeprecation] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.op_def.OpDefProto.javaDescriptor.getMessageTypes().get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.op_def.OpDefProto.scalaDescriptor.messages(1)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = OpDeprecation(
    version = 0,
    explanation = ""
  )
  implicit class OpDeprecationLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, OpDeprecation]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, OpDeprecation](_l) {
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[tensorboard.OpDeprecation])
}
