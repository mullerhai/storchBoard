...
package tensorflow.framework.tensor
...
import tensorflow.framework.{resource_handle, tensor, tensor_shape, types}
...
final case class TensorProto(
                              ...
                              resourceHandleVal: _root_.scala.Seq[ResourceHandleProto] = _root_.scala.Seq.empty,
                              variantVal: _root_.scala.Seq[VariantTensorDataProto] = _root_.scala.Seq.empty,
                              ...
                              float8Val: _root_.com.google.protobuf.ByteString = _root_.com.google.protobuf.ByteString.EMPTY,
    ...
    def withDtype(__v: DataType): TensorProto = copy(dtype = __v)
    ...
    def withTensorShape(__v: TensorShapeProto): TensorProto = copy(tensorShape = Option(__v))
    ...
    def addResourceHandleVal(__vs: ResourceHandleProto *): TensorProto = addAllResourceHandleVal(__vs)
    def addAllResourceHandleVal(__vs: Iterable[ResourceHandleProto]): TensorProto = copy(resourceHandleVal = resourceHandleVal ++ __vs)
    def withResourceHandleVal(__v: _root_.scala.Seq[ResourceHandleProto]): TensorProto = copy(resourceHandleVal = __v)
    def clearVariantVal = copy(variantVal = _root_.scala.Seq.empty)
    def addVariantVal(__vs: VariantTensorDataProto *): TensorProto = addAllVariantVal(__vs)
    def addAllVariantVal(__vs: Iterable[VariantTensorDataProto]): TensorProto = copy(variantVal = variantVal ++ __vs)
    def withVariantVal(__v: _root_.scala.Seq[VariantTensorDataProto]): TensorProto = copy(variantVal = __v)
    ...
    def withFloat8Val(__v: _root_.com.google.protobuf.ByteString): TensorProto = copy(float8Val = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 18 => _root_.scalapb.descriptors.PByteString(float8Val)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: TensorProto.type = tensor.TensorProto
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.TensorProto])
}

object TensorProto extends scalapb.GeneratedMessageCompanion[TensorProto] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[TensorProto] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): TensorProto = {
    ...
    val __resourceHandleVal: _root_.scala.collection.immutable.VectorBuilder[ResourceHandleProto] = new _root_.scala.collection.immutable.VectorBuilder[ResourceHandleProto]
    val __variantVal: _root_.scala.collection.immutable.VectorBuilder[VariantTensorDataProto] = new _root_.scala.collection.immutable.VectorBuilder[VariantTensorDataProto]
    ...
    var __float8Val: _root_.com.google.protobuf.ByteString = _root_.com.google.protobuf.ByteString.EMPTY
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 114 =>
          __resourceHandleVal += _root_.scalapb.LiteParser.readMessage[ResourceHandleProto](_input__)
        case 122 =>
          __variantVal += _root_.scalapb.LiteParser.readMessage[VariantTensorDataProto](_input__)
        case 128 =>
        ...
        case 146 =>
          __float8Val = _input__.readBytes()
        case tag =>
    ...
    TensorProto(
        ...
        float8Val = __float8Val,
        unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[TensorProto] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      TensorProto(
        ...
        tensorShape = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).flatMap(_.as[_root_.scala.Option[TensorShapeProto]]),
        ...
        resourceHandleVal = __fieldsMap.get(scalaDescriptor.findFieldByNumber(14).get).map(_.as[_root_.scala.Seq[ResourceHandleProto]]).getOrElse(_root_.scala.Seq.empty),
        variantVal = __fieldsMap.get(scalaDescriptor.findFieldByNumber(15).get).map(_.as[_root_.scala.Seq[VariantTensorDataProto]]).getOrElse(_root_.scala.Seq.empty),
        ...
        float8Val = __fieldsMap.get(scalaDescriptor.findFieldByNumber(18).get).map(_.as[_root_.com.google.protobuf.ByteString]).getOrElse(_root_.com.google.protobuf.ByteString.EMPTY)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.tensor.TensorProtoCompanion.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.tensor.TensorProtoCompanion.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 2 => __out = tensor_shape.TensorShapeProto
      case 14 => __out = resource_handle.ResourceHandleProto
      case 15 => __out = tensor.VariantTensorDataProto
    }
    __out
  }
  ...
  lazy val defaultInstance = TensorProto(
    ...
    float8Val = _root_.com.google.protobuf.ByteString.EMPTY
  )
  implicit class TensorProtoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, TensorProto]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, TensorProto](_l) {
    ...
    def resourceHandleVal: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[ResourceHandleProto]] = field(_.resourceHandleVal)((c_, f_) => c_.copy(resourceHandleVal = f_))
    def variantVal: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[VariantTensorDataProto]] = field(_.variantVal)((c_, f_) => c_.copy(variantVal = f_))
    ...
    def float8Val: _root_.scalapb.lenses.Lens[UpperPB, _root_.com.google.protobuf.ByteString] = field(_.float8Val)((c_, f_) => c_.copy(float8Val = f_))
  }
  ...
  final val FLOAT8_VAL_FIELD_NUMBER = 18
  def of(
          dtype: DataType,
          ...
          resourceHandleVal: _root_.scala.Seq[ResourceHandleProto],
          variantVal: _root_.scala.Seq[VariantTensorDataProto],
          uint32Val: _root_.scala.Seq[_root_.scala.Int],
          uint64Val: _root_.scala.Seq[_root_.scala.Long],
          float8Val: _root_.com.google.protobuf.ByteString
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[tensorboard.TensorProto])
}
