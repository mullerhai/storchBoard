...
package tensorflow.framework.versions
...
final case class VersionDef(
    ...
    def companion: VersionDef.type = versions.VersionDef
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.VersionDef])
}

object VersionDef extends scalapb.GeneratedMessageCompanion[VersionDef] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[VersionDef] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): VersionDef = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[VersionDef] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.versions.VersionsProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.versions.VersionsProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = VersionDef(
    producer = 0,
    minConsumer = 0,
    badConsumers = _root_.scala.Seq.empty
  )
  implicit class VersionDefLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, VersionDef]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, VersionDef](_l) {
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[tensorboard.VersionDef])
}
