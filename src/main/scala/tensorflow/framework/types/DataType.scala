...
sealed abstract class DataType(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
  ...
  type RecognizedType = DataType.Recognized
  ...
  def isDtFloat8E5M2: _root_.scala.Boolean = false
  def isDtFloat8E4M3Fn: _root_.scala.Boolean = false
  def isDtFloat8E4M3Fnuz: _root_.scala.Boolean = false
  def isDtFloat8E4M3B11Fnuz: _root_.scala.Boolean = false
  def isDtFloat8E5M2Fnuz: _root_.scala.Boolean = false
  def isDtInt4: _root_.scala.Boolean = false
  def isDtUint4: _root_.scala.Boolean = false
  ...
  def isDtFloat8E5M2Ref: _root_.scala.Boolean = false
  def isDtFloat8E4M3FnRef: _root_.scala.Boolean = false
  def isDtFloat8E4M3FnuzRef: _root_.scala.Boolean = false
  def isDtFloat8E4M3B11FnuzRef: _root_.scala.Boolean = false
  def isDtFloat8E5M2FnuzRef: _root_.scala.Boolean = false
  def isDtInt4Ref: _root_.scala.Boolean = false
  def isDtUint4Ref: _root_.scala.Boolean = false
  def companion: _root_.scalapb.GeneratedEnumCompanion[DataType] = types.DataType
  final def asRecognized: _root_.scala.Option[DataType.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[DataType.Recognized])
}
...
object DataType extends _root_.scalapb.GeneratedEnumCompanion[DataType] {
  ...
  /** 5 exponent bits, 2 mantissa bits.
    */
  @SerialVersionUID(0L)
  case object DT_FLOAT8_E5M2 extends DataType(24) with DataType.Recognized {
    val index = 24
    val name = "DT_FLOAT8_E5M2"
    override def isDtFloat8E5M2: _root_.scala.Boolean = true
  }
  
  /** 4 exponent bits, 3 mantissa bits, finite-only, with
    */
  @SerialVersionUID(0L)
  case object DT_FLOAT8_E4M3FN extends DataType(25) with DataType.Recognized {
    val index = 25
    val name = "DT_FLOAT8_E4M3FN"
    override def isDtFloat8E4M3Fn: _root_.scala.Boolean = true
  }
  ...
  /** 2 NaNs (0bS1111111).
    ...
    */
  @SerialVersionUID(0L)
  case object DT_FLOAT8_E4M3FNUZ extends DataType(26) with DataType.Recognized {
    val index = 26
    val name = "DT_FLOAT8_E4M3FNUZ"
    override def isDtFloat8E4M3Fnuz: _root_.scala.Boolean = true
  }
  ...
  /** with NaN.
    ...
    */
  @SerialVersionUID(0L)
  case object DT_FLOAT8_E4M3B11FNUZ extends DataType(27) with DataType.Recognized {
    val index = 27
    val name = "DT_FLOAT8_E4M3B11FNUZ"
    override def isDtFloat8E4M3B11Fnuz: _root_.scala.Boolean = true
  }
  ...
  /** bias, finite-only, with NaNs.
    ...
    */
  @SerialVersionUID(0L)
  case object DT_FLOAT8_E5M2FNUZ extends DataType(28) with DataType.Recognized {
    val index = 28
    val name = "DT_FLOAT8_E5M2FNUZ"
    override def isDtFloat8E5M2Fnuz: _root_.scala.Boolean = true
  }
  
  @SerialVersionUID(0L)
  case object DT_INT4 extends DataType(29) with DataType.Recognized {
    val index = 29
    val name = "DT_INT4"
    override def isDtInt4: _root_.scala.Boolean = true
  }
  
  @SerialVersionUID(0L)
  case object DT_UINT4 extends DataType(30) with DataType.Recognized {
    val index = 30
    val name = "DT_UINT4"
    override def isDtUint4: _root_.scala.Boolean = true
  }
  ...
  @SerialVersionUID(0L)
  case object DT_FLOAT8_E5M2_REF extends DataType(124) with DataType.Recognized {
    val index = 54
    val name = "DT_FLOAT8_E5M2_REF"
    override def isDtFloat8E5M2Ref: _root_.scala.Boolean = true
  }
  
  @SerialVersionUID(0L)
  case object DT_FLOAT8_E4M3FN_REF extends DataType(125) with DataType.Recognized {
    val index = 55
    val name = "DT_FLOAT8_E4M3FN_REF"
    override def isDtFloat8E4M3FnRef: _root_.scala.Boolean = true
  }
  
  @SerialVersionUID(0L)
  case object DT_FLOAT8_E4M3FNUZ_REF extends DataType(126) with DataType.Recognized {
    val index = 56
    val name = "DT_FLOAT8_E4M3FNUZ_REF"
    override def isDtFloat8E4M3FnuzRef: _root_.scala.Boolean = true
  }
  
  @SerialVersionUID(0L)
  case object DT_FLOAT8_E4M3B11FNUZ_REF extends DataType(127) with DataType.Recognized {
    val index = 57
    val name = "DT_FLOAT8_E4M3B11FNUZ_REF"
    override def isDtFloat8E4M3B11FnuzRef: _root_.scala.Boolean = true
  }
  
  @SerialVersionUID(0L)
  case object DT_FLOAT8_E5M2FNUZ_REF extends DataType(128) with DataType.Recognized {
    val index = 58
    val name = "DT_FLOAT8_E5M2FNUZ_REF"
    override def isDtFloat8E5M2FnuzRef: _root_.scala.Boolean = true
  }
  
  @SerialVersionUID(0L)
  case object DT_INT4_REF extends DataType(129) with DataType.Recognized {
    val index = 59
    val name = "DT_INT4_REF"
    override def isDtInt4Ref: _root_.scala.Boolean = true
  }
  
  @SerialVersionUID(0L)
  case object DT_UINT4_REF extends DataType(130) with DataType.Recognized {
    val index = 60
    val name = "DT_UINT4_REF"
    override def isDtUint4Ref: _root_.scala.Boolean = true
  }
  ...
  lazy val values: scala.collection.immutable.Seq[ValueType] = scala.collection.immutable.Seq(DT_INVALID, DT_FLOAT, DT_DOUBLE, DT_INT32, DT_UINT8, DT_INT16, DT_INT8, DT_STRING, DT_COMPLEX64, DT_INT64, DT_BOOL, DT_QINT8, DT_QUINT8, DT_QINT32, DT_BFLOAT16, DT_QINT16, DT_QUINT16, DT_UINT16, DT_COMPLEX128, DT_HALF, DT_RESOURCE, DT_VARIANT, DT_UINT32, DT_UINT64, DT_FLOAT8_E5M2, DT_FLOAT8_E4M3FN, DT_FLOAT8_E4M3FNUZ, DT_FLOAT8_E4M3B11FNUZ, DT_FLOAT8_E5M2FNUZ, DT_INT4, DT_UINT4, DT_FLOAT_REF, DT_DOUBLE_REF, DT_INT32_REF, DT_UINT8_REF, DT_INT16_REF, DT_INT8_REF, DT_STRING_REF, DT_COMPLEX64_REF, DT_INT64_REF, DT_BOOL_REF, DT_QINT8_REF, DT_QUINT8_REF, DT_QINT32_REF, DT_BFLOAT16_REF, DT_QINT16_REF, DT_QUINT16_REF, DT_UINT16_REF, DT_COMPLEX128_REF, DT_HALF_REF, DT_RESOURCE_REF, DT_VARIANT_REF, DT_UINT32_REF, DT_UINT64_REF, DT_FLOAT8_E5M2_REF, DT_FLOAT8_E4M3FN_REF, DT_FLOAT8_E4M3FNUZ_REF, DT_FLOAT8_E4M3B11FNUZ_REF, DT_FLOAT8_E5M2FNUZ_REF, DT_INT4_REF, DT_UINT4_REF)
  def fromValue(__value: _root_.scala.Int): DataType = __value match {
    ...
    case 22 => DT_UINT32
    case 23 => DT_UINT64
    case 24 => DT_FLOAT8_E5M2
    case 25 => DT_FLOAT8_E4M3FN
    case 26 => DT_FLOAT8_E4M3FNUZ
    case 27 => DT_FLOAT8_E4M3B11FNUZ
    case 28 => DT_FLOAT8_E5M2FNUZ
    case 29 => DT_INT4
    case 30 => DT_UINT4
    ...
    case 124 => DT_FLOAT8_E5M2_REF
    case 125 => DT_FLOAT8_E4M3FN_REF
    case 126 => DT_FLOAT8_E4M3FNUZ_REF
    case 127 => DT_FLOAT8_E4M3B11FNUZ_REF
    case 128 => DT_FLOAT8_E5M2FNUZ_REF
    case 129 => DT_INT4_REF
    case 130 => DT_UINT4_REF
    case __other => Unrecognized(__other)
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = org.tensorflow.framework.types.TypesProto.javaDescriptor.getEnumTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = org.tensorflow.framework.types.TypesProto.scalaDescriptor.enums(0)
}