...
final case class MemoryStats(
    ...
    def companion: MemoryStats.type = step_stats.MemoryStats
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.MemoryStats])
}

object MemoryStats extends scalapb.GeneratedMessageCompanion[MemoryStats] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[MemoryStats] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): MemoryStats = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[MemoryStats] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = MemoryStats(
    tempMemorySize = 0L,
  ...
  implicit class MemoryStatsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, MemoryStats]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, MemoryStats](_l) {
