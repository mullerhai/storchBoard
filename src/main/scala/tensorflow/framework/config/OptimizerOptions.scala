...
final case class OptimizerOptions(
                                   ...
                                   optLevel: OptimizerOptions.Level = config.OptimizerOptions.Level.L1,
                                   globalJitLevel: OptimizerOptions.GlobalJitLevel = config.OptimizerOptions.GlobalJitLevel.DEFAULT,
    ...
    def withOptLevel(__v: OptimizerOptions.Level): OptimizerOptions = copy(optLevel = __v)
    def withGlobalJitLevel(__v: OptimizerOptions.GlobalJitLevel): OptimizerOptions = copy(globalJitLevel = __v)
    ...
    def companion: OptimizerOptions.type = config.OptimizerOptions
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.OptimizerOptions])
}

object OptimizerOptions extends scalapb.GeneratedMessageCompanion[OptimizerOptions] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[OptimizerOptions] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): OptimizerOptions = {
    ...
    var __optLevel: OptimizerOptions.Level = config.OptimizerOptions.Level.L1
    var __globalJitLevel: OptimizerOptions.GlobalJitLevel = config.OptimizerOptions.GlobalJitLevel.DEFAULT
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 24 =>
          __optLevel = config.OptimizerOptions.Level.fromValue(_input__.readEnum())
        case 40 =>
          __globalJitLevel = config.OptimizerOptions.GlobalJitLevel.fromValue(_input__.readEnum())
        case 56 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[OptimizerOptions] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      OptimizerOptions(
        ...
        optLevel = config.OptimizerOptions.Level.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(config.OptimizerOptions.Level.L1.scalaValueDescriptor).number),
        globalJitLevel = config.OptimizerOptions.GlobalJitLevel.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(config.OptimizerOptions.GlobalJitLevel.DEFAULT.scalaValueDescriptor).number),
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 3 => config.OptimizerOptions.Level
      case 5 => config.OptimizerOptions.GlobalJitLevel
    }
  }
  lazy val defaultInstance = OptimizerOptions(
    doCommonSubexpressionElimination = false,
    doConstantFolding = false,
    maxFoldedConstantInBytes = 0L,
    doFunctionInlining = false,
    optLevel = config.OptimizerOptions.Level.L1,
    globalJitLevel = config.OptimizerOptions.GlobalJitLevel.DEFAULT,
    cpuGlobalJit = false
  )
  /** Optimization level
    */
  sealed abstract class Level(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    type EnumType = OptimizerOptions.Level
    type RecognizedType = OptimizerOptions.Level.Recognized
    def isL1: _root_.scala.Boolean = false
    def isL0: _root_.scala.Boolean = false
    def companion: _root_.scalapb.GeneratedEnumCompanion[Level] = config.OptimizerOptions.Level
    final def asRecognized: _root_.scala.Option[OptimizerOptions.Level.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[OptimizerOptions.Level.Recognized])
  }
  ...
  object Level extends _root_.scalapb.GeneratedEnumCompanion[Level] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = config.OptimizerOptions.javaDescriptor.getEnumTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = config.OptimizerOptions.scalaDescriptor.enums(0)
  }
  /** Control the use of the compiler/jit.  Experimental.
    */
  sealed abstract class GlobalJitLevel(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    type EnumType = OptimizerOptions.GlobalJitLevel
    type RecognizedType = OptimizerOptions.GlobalJitLevel.Recognized
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[GlobalJitLevel] = config.OptimizerOptions.GlobalJitLevel
    final def asRecognized: _root_.scala.Option[OptimizerOptions.GlobalJitLevel.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[OptimizerOptions.GlobalJitLevel.Recognized])
  }
  ...
  object GlobalJitLevel extends _root_.scalapb.GeneratedEnumCompanion[GlobalJitLevel] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = config.OptimizerOptions.javaDescriptor.getEnumTypes().get(1)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = config.OptimizerOptions.scalaDescriptor.enums(1)
  }
  implicit class OptimizerOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, OptimizerOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, OptimizerOptions](_l) {
    ...
    def optLevel: _root_.scalapb.lenses.Lens[UpperPB, OptimizerOptions.Level] = field(_.optLevel)((c_, f_) => c_.copy(optLevel = f_))
    def globalJitLevel: _root_.scalapb.lenses.Lens[UpperPB, OptimizerOptions.GlobalJitLevel] = field(_.globalJitLevel)((c_, f_) => c_.copy(globalJitLevel = f_))
  ...
  def of(
          ...
          optLevel: OptimizerOptions.Level,
          globalJitLevel: OptimizerOptions.GlobalJitLevel,
