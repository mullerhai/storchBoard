...
import tensorflow.framework.debug.DebugOptions
import tensorflow.framework.{config, debug}
...
final case class RunOptions(
                             traceLevel: RunOptions.TraceLevel = config.RunOptions.TraceLevel.NO_TRACE,
                             timeoutInMs: _root_.scala.Long = 0L,
                             interOpThreadPool: _root_.scala.Int = 0,
                             outputPartitionGraphs: _root_.scala.Boolean = false,
                             debugOptions: _root_.scala.Option[DebugOptions] = _root_.scala.None,
                             reportTensorAllocationsUponOom: _root_.scala.Boolean = false,
                             experimental: _root_.scala.Option[RunOptions.Experimental] = _root_.scala.None,
    ...
    def withTraceLevel(__v: RunOptions.TraceLevel): RunOptions = copy(traceLevel = __v)
    ...
    def getDebugOptions: DebugOptions = debugOptions.getOrElse(debug.DebugOptions.defaultInstance)
    def clearDebugOptions: RunOptions = copy(debugOptions = _root_.scala.None)
    def withDebugOptions(__v: DebugOptions): RunOptions = copy(debugOptions = Option(__v))
    def withReportTensorAllocationsUponOom(__v: _root_.scala.Boolean): RunOptions = copy(reportTensorAllocationsUponOom = __v)
    def getExperimental: RunOptions.Experimental = experimental.getOrElse(config.RunOptions.Experimental.defaultInstance)
    def clearExperimental: RunOptions = copy(experimental = _root_.scala.None)
    def withExperimental(__v: RunOptions.Experimental): RunOptions = copy(experimental = Option(__v))
    ...
    def companion: RunOptions.type = config.RunOptions
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.RunOptions])
}

object RunOptions extends scalapb.GeneratedMessageCompanion[RunOptions] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[RunOptions] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): RunOptions = {
    var __traceLevel: RunOptions.TraceLevel = config.RunOptions.TraceLevel.NO_TRACE
    ...
    var __debugOptions: _root_.scala.Option[DebugOptions] = _root_.scala.None
    var __reportTensorAllocationsUponOom: _root_.scala.Boolean = false
    var __experimental: _root_.scala.Option[RunOptions.Experimental] = _root_.scala.None
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 8 =>
          __traceLevel = config.RunOptions.TraceLevel.fromValue(_input__.readEnum())
        case 16 =>
        ...
        case 50 =>
          __debugOptions = _root_.scala.Option(__debugOptions.fold(_root_.scalapb.LiteParser.readMessage[DebugOptions](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 56 =>
          __reportTensorAllocationsUponOom = _input__.readBool()
        case 66 =>
          __experimental = _root_.scala.Option(__experimental.fold(_root_.scalapb.LiteParser.readMessage[RunOptions.Experimental](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[RunOptions] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      RunOptions(
        traceLevel = config.RunOptions.TraceLevel.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(config.RunOptions.TraceLevel.NO_TRACE.scalaValueDescriptor).number),
        ...
        debugOptions = __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).flatMap(_.as[_root_.scala.Option[DebugOptions]]),
        ...
        experimental = __fieldsMap.get(scalaDescriptor.findFieldByNumber(8).get).flatMap(_.as[_root_.scala.Option[RunOptions.Experimental]])
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 6 => __out = debug.DebugOptions
      case 8 => __out = config.RunOptions.Experimental
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]](
      config.RunOptions.Experimental
    )
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 1 => config.RunOptions.TraceLevel
    }
  }
  lazy val defaultInstance = RunOptions(
    traceLevel = config.RunOptions.TraceLevel.NO_TRACE,
    timeoutInMs = 0L,
    interOpThreadPool = 0,
  ...
  sealed abstract class TraceLevel(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    type EnumType = RunOptions.TraceLevel
    type RecognizedType = RunOptions.TraceLevel.Recognized
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[TraceLevel] = config.RunOptions.TraceLevel
    final def asRecognized: _root_.scala.Option[RunOptions.TraceLevel.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[RunOptions.TraceLevel.Recognized])
  }
  ...
  object TraceLevel extends _root_.scalapb.GeneratedEnumCompanion[TraceLevel] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = config.RunOptions.javaDescriptor.getEnumTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = config.RunOptions.scalaDescriptor.enums(0)
  }
  ...
  final case class Experimental(
                                 ...
                                 runHandlerPoolOptions: _root_.scala.Option[RunOptions.Experimental.RunHandlerPoolOptions] = _root_.scala.None,
                                 unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
      ...
      def getRunHandlerPoolOptions: RunOptions.Experimental.RunHandlerPoolOptions = runHandlerPoolOptions.getOrElse(config.RunOptions.Experimental.RunHandlerPoolOptions.defaultInstance)
      def clearRunHandlerPoolOptions: Experimental = copy(runHandlerPoolOptions = _root_.scala.None)
      def withRunHandlerPoolOptions(__v: RunOptions.Experimental.RunHandlerPoolOptions): Experimental = copy(runHandlerPoolOptions = Option(__v))
      def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
      def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
      def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
        (__fieldNumber: @_root_.scala.unchecked) match {
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: RunOptions.Experimental.type = config.RunOptions.Experimental
      // @@protoc_insertion_point(GeneratedMessage[tensorboard.RunOptions.Experimental])
  }
  
  object Experimental extends scalapb.GeneratedMessageCompanion[RunOptions.Experimental] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[RunOptions.Experimental] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): RunOptions.Experimental = {
      var __collectiveGraphKey: _root_.scala.Long = 0L
      var __useRunHandlerPool: _root_.scala.Boolean = false
      var __runHandlerPoolOptions: _root_.scala.Option[RunOptions.Experimental.RunHandlerPoolOptions] = _root_.scala.None
      var `_unknownFields__`: _root_.scalapb.UnknownFieldSet.Builder = null
      var _done__ = false
      while (!_done__) {
        val _tag__ = _input__.readTag()
        _tag__ match {
          ...
          case 26 =>
            __runHandlerPoolOptions = _root_.scala.Option(__runHandlerPoolOptions.fold(_root_.scalapb.LiteParser.readMessage[RunOptions.Experimental.RunHandlerPoolOptions](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
          case tag =>
            if (_unknownFields__ == null) {
              _unknownFields__ = new _root_.scalapb.UnknownFieldSet.Builder()
            }
    ...
    implicit def messageReads: _root_.scalapb.descriptors.Reads[RunOptions.Experimental] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        config.RunOptions.Experimental(
          ...
          runHandlerPoolOptions = __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).flatMap(_.as[_root_.scala.Option[RunOptions.Experimental.RunHandlerPoolOptions]])
        )
      case _ => throw new RuntimeException("Expected PMessage")
    }
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = config.RunOptions.javaDescriptor.getNestedTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = config.RunOptions.scalaDescriptor.nestedMessages(0)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
      var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
      (__number: @_root_.scala.unchecked) match {
        case 3 => __out = config.RunOptions.Experimental.RunHandlerPoolOptions
      }
      __out
    }
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] =
      Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]](
        config.RunOptions.Experimental.RunHandlerPoolOptions
      )
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
    lazy val defaultInstance = config.RunOptions.Experimental(
    ...
    final case class RunHandlerPoolOptions(
        ...
        def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
        def companion: RunOptions.Experimental.RunHandlerPoolOptions.type = config.RunOptions.Experimental.RunHandlerPoolOptions
        // @@protoc_insertion_point(GeneratedMessage[tensorboard.RunOptions.Experimental.RunHandlerPoolOptions])
    }
    
    object RunHandlerPoolOptions extends scalapb.GeneratedMessageCompanion[RunOptions.Experimental.RunHandlerPoolOptions] {
      implicit def messageCompanion: scalapb.GeneratedMessageCompanion[RunOptions.Experimental.RunHandlerPoolOptions] = this
      def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): RunOptions.Experimental.RunHandlerPoolOptions = {
      ...
      implicit def messageReads: _root_.scalapb.descriptors.Reads[RunOptions.Experimental.RunHandlerPoolOptions] = _root_.scalapb.descriptors.Reads{
        case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
          _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
          config.RunOptions.Experimental.RunHandlerPoolOptions(
      ...
      def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = config.RunOptions.Experimental.javaDescriptor.getNestedTypes().get(0)
      def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = config.RunOptions.Experimental.scalaDescriptor.nestedMessages(0)
      def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
      lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
      def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
      lazy val defaultInstance = config.RunOptions.Experimental.RunHandlerPoolOptions(
        priority = 0L
      )
      implicit class RunHandlerPoolOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, RunOptions.Experimental.RunHandlerPoolOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, RunOptions.Experimental.RunHandlerPoolOptions](_l) {
      ...
      ): RunOptions.Experimental.RunHandlerPoolOptions = config.RunOptions.Experimental.RunHandlerPoolOptions(
        priority
      )
      // @@protoc_insertion_point(GeneratedMessageCompanion[tensorboard.RunOptions.Experimental.RunHandlerPoolOptions])
    }
    
    implicit class ExperimentalLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, RunOptions.Experimental]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, RunOptions.Experimental](_l) {
      ...
      def runHandlerPoolOptions: _root_.scalapb.lenses.Lens[UpperPB, RunOptions.Experimental.RunHandlerPoolOptions] = field(_.getRunHandlerPoolOptions)((c_, f_) => c_.copy(runHandlerPoolOptions = _root_.scala.Option(f_)))
      def optionalRunHandlerPoolOptions: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[RunOptions.Experimental.RunHandlerPoolOptions]] = field(_.runHandlerPoolOptions)((c_, f_) => c_.copy(runHandlerPoolOptions = f_))
    }
    ...
    def of(
      ...
      runHandlerPoolOptions: _root_.scala.Option[RunOptions.Experimental.RunHandlerPoolOptions]
    ): RunOptions.Experimental = config.RunOptions.Experimental(
      collectiveGraphKey,
      useRunHandlerPool,
  ...
  implicit class RunOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, RunOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, RunOptions](_l) {
    def traceLevel: _root_.scalapb.lenses.Lens[UpperPB, RunOptions.TraceLevel] = field(_.traceLevel)((c_, f_) => c_.copy(traceLevel = f_))
    ...
    def debugOptions: _root_.scalapb.lenses.Lens[UpperPB, DebugOptions] = field(_.getDebugOptions)((c_, f_) => c_.copy(debugOptions = _root_.scala.Option(f_)))
    def optionalDebugOptions: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[DebugOptions]] = field(_.debugOptions)((c_, f_) => c_.copy(debugOptions = f_))
    ...
    def experimental: _root_.scalapb.lenses.Lens[UpperPB, RunOptions.Experimental] = field(_.getExperimental)((c_, f_) => c_.copy(experimental = _root_.scala.Option(f_)))
    def optionalExperimental: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[RunOptions.Experimental]] = field(_.experimental)((c_, f_) => c_.copy(experimental = f_))
  }
