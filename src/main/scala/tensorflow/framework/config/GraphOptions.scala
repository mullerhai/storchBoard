...
import tensorflow.framework.rewriter_config.RewriterConfig
import tensorflow.framework.{config, rewriter_config}
...
final case class GraphOptions(
                               ...
                               optimizerOptions: _root_.scala.Option[OptimizerOptions] = _root_.scala.None,
                               ...
                               rewriteOptions: _root_.scala.Option[RewriterConfig] = _root_.scala.None,
    ...
    def getOptimizerOptions: OptimizerOptions = optimizerOptions.getOrElse(config.OptimizerOptions.defaultInstance)
    def clearOptimizerOptions: GraphOptions = copy(optimizerOptions = _root_.scala.None)
    def withOptimizerOptions(__v: OptimizerOptions): GraphOptions = copy(optimizerOptions = Option(__v))
    ...
    def getRewriteOptions: RewriterConfig = rewriteOptions.getOrElse(RewriterConfig.defaultInstance)
    def clearRewriteOptions: GraphOptions = copy(rewriteOptions = _root_.scala.None)
    def withRewriteOptions(__v: RewriterConfig): GraphOptions = copy(rewriteOptions = Option(__v))
    ...
    def companion: GraphOptions.type = config.GraphOptions
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.GraphOptions])
}

object GraphOptions extends scalapb.GeneratedMessageCompanion[GraphOptions] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[GraphOptions] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): GraphOptions = {
    var __enableRecvScheduling: _root_.scala.Boolean = false
    var __optimizerOptions: _root_.scala.Option[OptimizerOptions] = _root_.scala.None
    ...
    var __rewriteOptions: _root_.scala.Option[RewriterConfig] = _root_.scala.None
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 26 =>
          __optimizerOptions = _root_.scala.Option(__optimizerOptions.fold(_root_.scalapb.LiteParser.readMessage[OptimizerOptions](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 32 =>
        ...
        case 82 =>
          __rewriteOptions = _root_.scala.Option(__rewriteOptions.fold(_root_.scalapb.LiteParser.readMessage[RewriterConfig](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[GraphOptions] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      GraphOptions(
        ...
        optimizerOptions = __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).flatMap(_.as[_root_.scala.Option[OptimizerOptions]]),
        ...
        rewriteOptions = __fieldsMap.get(scalaDescriptor.findFieldByNumber(10).get).flatMap(_.as[_root_.scala.Option[RewriterConfig]])
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 3 => __out = config.OptimizerOptions
      case 10 => __out = rewriter_config.RewriterConfig
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = GraphOptions(
  ...
  implicit class GraphOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, GraphOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, GraphOptions](_l) {
    ...
    def optimizerOptions: _root_.scalapb.lenses.Lens[UpperPB, OptimizerOptions] = field(_.getOptimizerOptions)((c_, f_) => c_.copy(optimizerOptions = _root_.scala.Option(f_)))
    def optionalOptimizerOptions: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[OptimizerOptions]] = field(_.optimizerOptions)((c_, f_) => c_.copy(optimizerOptions = f_))
    ...
    def rewriteOptions: _root_.scalapb.lenses.Lens[UpperPB, RewriterConfig] = field(_.getRewriteOptions)((c_, f_) => c_.copy(rewriteOptions = _root_.scala.Option(f_)))
    def optionalRewriteOptions: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[RewriterConfig]] = field(_.rewriteOptions)((c_, f_) => c_.copy(rewriteOptions = f_))
  }
  ...
  def of(
          ...
          optimizerOptions: _root_.scala.Option[OptimizerOptions],
          ...
          rewriteOptions: _root_.scala.Option[RewriterConfig]
