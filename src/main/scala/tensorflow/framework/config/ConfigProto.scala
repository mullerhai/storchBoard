...
import tensorflow.distruntime.cluster.ClusterDef
...
final case class ConfigProto(
                              ...
                              sessionInterOpThreadPool: _root_.scala.Seq[ThreadPoolOptionProto] = _root_.scala.Seq.empty,
                              placementPeriod: _root_.scala.Int = 0,
                              deviceFilters: _root_.scala.Seq[_root_.scala.Predef.String] = _root_.scala.Seq.empty,
                              gpuOptions: _root_.scala.Option[GPUOptions] = _root_.scala.None,
                              pluggableDeviceOptions: _root_.scala.Option[GPUOptions] = _root_.scala.None,
                              allowSoftPlacement: _root_.scala.Boolean = false,
                              logDevicePlacement: _root_.scala.Boolean = false,
                              graphOptions: _root_.scala.Option[GraphOptions] = _root_.scala.None,
                              ...
                              clusterDef: _root_.scala.Option[ClusterDef] = _root_.scala.None,
                              isolateSessionState: _root_.scala.Boolean = false,
                              shareClusterDevicesInSession: _root_.scala.Boolean = false,
                              experimental: _root_.scala.Option[ConfigProto.Experimental] = _root_.scala.None,
    ...
    private[this] def __computeSerializedSize(): _root_.scala.Int = {
      ...
      deviceCount.foreach { __item =>
        val __value = config.ConfigProto._typemapper_deviceCount.toBase(__item)
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      deviceCount.foreach { __v =>
        val __m = config.ConfigProto._typemapper_deviceCount.toBase(__v)
    ...
    def addSessionInterOpThreadPool(__vs: ThreadPoolOptionProto *): ConfigProto = addAllSessionInterOpThreadPool(__vs)
    def addAllSessionInterOpThreadPool(__vs: Iterable[ThreadPoolOptionProto]): ConfigProto = copy(sessionInterOpThreadPool = sessionInterOpThreadPool ++ __vs)
    def withSessionInterOpThreadPool(__v: _root_.scala.Seq[ThreadPoolOptionProto]): ConfigProto = copy(sessionInterOpThreadPool = __v)
    ...
    def getGpuOptions: GPUOptions = gpuOptions.getOrElse(config.GPUOptions.defaultInstance)
    def clearGpuOptions: ConfigProto = copy(gpuOptions = _root_.scala.None)
    def withGpuOptions(__v: GPUOptions): ConfigProto = copy(gpuOptions = Option(__v))
    def getPluggableDeviceOptions: GPUOptions = pluggableDeviceOptions.getOrElse(config.GPUOptions.defaultInstance)
    def clearPluggableDeviceOptions: ConfigProto = copy(pluggableDeviceOptions = _root_.scala.None)
    def withPluggableDeviceOptions(__v: GPUOptions): ConfigProto = copy(pluggableDeviceOptions = Option(__v))
    ...
    def getGraphOptions: GraphOptions = graphOptions.getOrElse(config.GraphOptions.defaultInstance)
    def clearGraphOptions: ConfigProto = copy(graphOptions = _root_.scala.None)
    def withGraphOptions(__v: GraphOptions): ConfigProto = copy(graphOptions = Option(__v))
    ...
    def getClusterDef: ClusterDef = clusterDef.getOrElse(ClusterDef.defaultInstance)
    def clearClusterDef: ConfigProto = copy(clusterDef = _root_.scala.None)
    def withClusterDef(__v: ClusterDef): ConfigProto = copy(clusterDef = Option(__v))
    ...
    def getExperimental: ConfigProto.Experimental = experimental.getOrElse(config.ConfigProto.Experimental.defaultInstance)
    def clearExperimental: ConfigProto = copy(experimental = _root_.scala.None)
    def withExperimental(__v: ConfigProto.Experimental): ConfigProto = copy(experimental = Option(__v))
    def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
    def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        case 1 => deviceCount.iterator.map(config.ConfigProto._typemapper_deviceCount.toBase(_)).toSeq
        case 2 => {
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        case 1 => _root_.scalapb.descriptors.PRepeated(deviceCount.iterator.map(config.ConfigProto._typemapper_deviceCount.toBase(_).toPMessage).toVector)
    ...
    def companion: ConfigProto.type = config.ConfigProto
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.ConfigProto])
}

object ConfigProto extends scalapb.GeneratedMessageCompanion[ConfigProto] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ConfigProto] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ConfigProto = {
    ...
    val __sessionInterOpThreadPool: _root_.scala.collection.immutable.VectorBuilder[ThreadPoolOptionProto] = new _root_.scala.collection.immutable.VectorBuilder[ThreadPoolOptionProto]
    ...
    var __gpuOptions: _root_.scala.Option[GPUOptions] = _root_.scala.None
    var __pluggableDeviceOptions: _root_.scala.Option[GPUOptions] = _root_.scala.None
    var __allowSoftPlacement: _root_.scala.Boolean = false
    var __logDevicePlacement: _root_.scala.Boolean = false
    var __graphOptions: _root_.scala.Option[GraphOptions] = _root_.scala.None
    ...
    var __clusterDef: _root_.scala.Option[ClusterDef] = _root_.scala.None
    var __isolateSessionState: _root_.scala.Boolean = false
    var __shareClusterDevicesInSession: _root_.scala.Boolean = false
    var __experimental: _root_.scala.Option[ConfigProto.Experimental] = _root_.scala.None
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 10 =>
          __deviceCount += config.ConfigProto._typemapper_deviceCount.toCustom(_root_.scalapb.LiteParser.readMessage[ConfigProto.DeviceCountEntry](_input__))
        case 16 =>
        ...
        case 98 =>
          __sessionInterOpThreadPool += _root_.scalapb.LiteParser.readMessage[ThreadPoolOptionProto](_input__)
        case 24 =>
          __placementPeriod = _input__.readInt32()
        case 34 =>
          __deviceFilters += _input__.readStringRequireUtf8()
        case 50 =>
          __gpuOptions = _root_.scala.Option(__gpuOptions.fold(_root_.scalapb.LiteParser.readMessage[GPUOptions](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 146 =>
          __pluggableDeviceOptions = _root_.scala.Option(__pluggableDeviceOptions.fold(_root_.scalapb.LiteParser.readMessage[GPUOptions](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 56 =>
          __allowSoftPlacement = _input__.readBool()
        case 64 =>
          __logDevicePlacement = _input__.readBool()
        case 82 =>
          __graphOptions = _root_.scala.Option(__graphOptions.fold(_root_.scalapb.LiteParser.readMessage[GraphOptions](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 88 =>
        ...
        case 114 =>
          __clusterDef = _root_.scala.Option(__clusterDef.fold(_root_.scalapb.LiteParser.readMessage[ClusterDef](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 120 =>
          __isolateSessionState = _input__.readBool()
        case 136 =>
          __shareClusterDevicesInSession = _input__.readBool()
        case 130 =>
          __experimental = _root_.scala.Option(__experimental.fold(_root_.scalapb.LiteParser.readMessage[ConfigProto.Experimental](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[ConfigProto] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      ConfigProto(
        deviceCount = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Seq[ConfigProto.DeviceCountEntry]]).getOrElse(_root_.scala.Seq.empty).iterator.map(config.ConfigProto._typemapper_deviceCount.toCustom(_)).toMap,
        ...
        sessionInterOpThreadPool = __fieldsMap.get(scalaDescriptor.findFieldByNumber(12).get).map(_.as[_root_.scala.Seq[ThreadPoolOptionProto]]).getOrElse(_root_.scala.Seq.empty),
        ...
        gpuOptions = __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).flatMap(_.as[_root_.scala.Option[GPUOptions]]),
        pluggableDeviceOptions = __fieldsMap.get(scalaDescriptor.findFieldByNumber(18).get).flatMap(_.as[_root_.scala.Option[GPUOptions]]),
        ...
        graphOptions = __fieldsMap.get(scalaDescriptor.findFieldByNumber(10).get).flatMap(_.as[_root_.scala.Option[GraphOptions]]),
        ...
        clusterDef = __fieldsMap.get(scalaDescriptor.findFieldByNumber(14).get).flatMap(_.as[_root_.scala.Option[ClusterDef]]),
        ...
        experimental = __fieldsMap.get(scalaDescriptor.findFieldByNumber(16).get).flatMap(_.as[_root_.scala.Option[ConfigProto.Experimental]])
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 1 => __out = config.ConfigProto.DeviceCountEntry
      case 12 => __out = config.ThreadPoolOptionProto
      case 6 => __out = config.GPUOptions
      case 18 => __out = config.GPUOptions
      case 10 => __out = config.GraphOptions
      case 13 => __out = tensorboard.rpc_options.RPCOptions
      case 14 => __out = cluster.ClusterDef
      case 16 => __out = config.ConfigProto.Experimental
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]](
      ...
      config.ConfigProto.Experimental
    )
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = ConfigProto(
  ...
  final case class DeviceCountEntry(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: ConfigProto.DeviceCountEntry.type = config.ConfigProto.DeviceCountEntry
      // @@protoc_insertion_point(GeneratedMessage[tensorboard.ConfigProto.DeviceCountEntry])
  }
  
  object DeviceCountEntry extends scalapb.GeneratedMessageCompanion[ConfigProto.DeviceCountEntry] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ConfigProto.DeviceCountEntry] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ConfigProto.DeviceCountEntry = {
    ...
    implicit def messageReads: _root_.scalapb.descriptors.Reads[ConfigProto.DeviceCountEntry] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        config.ConfigProto.DeviceCountEntry(
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = config.ConfigProto.javaDescriptor.getNestedTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = config.ConfigProto.scalaDescriptor.nestedMessages(0)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
    lazy val defaultInstance = config.ConfigProto.DeviceCountEntry(
      key = "",
      value = 0
    )
    implicit class DeviceCountEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ConfigProto.DeviceCountEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ConfigProto.DeviceCountEntry](_l) {
    ...
    @transient
    implicit val keyValueMapper: _root_.scalapb.TypeMapper[ConfigProto.DeviceCountEntry, (_root_.scala.Predef.String, _root_.scala.Int)] =
      _root_.scalapb.TypeMapper[ConfigProto.DeviceCountEntry, (_root_.scala.Predef.String, _root_.scala.Int)](__m => (__m.key, __m.value))(__p => config.ConfigProto.DeviceCountEntry(__p._1, __p._2))
    def of(
      key: _root_.scala.Predef.String,
      value: _root_.scala.Int
    ): ConfigProto.DeviceCountEntry = config.ConfigProto.DeviceCountEntry(
      key,
      value
    )
  ...
  final case class Experimental(
                                 ...
                                 mlirBridgeRollout: ConfigProto.Experimental.MlirBridgeRollout = config.ConfigProto.Experimental.MlirBridgeRollout.MLIR_BRIDGE_ROLLOUT_UNSPECIFIED,
      ...
      def withSessionMetadata(__v: SessionMetadata): Experimental = copy(sessionMetadata = Option(__v))
      ...
      def withMlirBridgeRollout(__v: ConfigProto.Experimental.MlirBridgeRollout): Experimental = copy(mlirBridgeRollout = __v)
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: ConfigProto.Experimental.type = config.ConfigProto.Experimental
      // @@protoc_insertion_point(GeneratedMessage[tensorboard.ConfigProto.Experimental])
  }
  
  object Experimental extends scalapb.GeneratedMessageCompanion[ConfigProto.Experimental] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ConfigProto.Experimental] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ConfigProto.Experimental = {
      ...
      var __mlirBridgeRollout: ConfigProto.Experimental.MlirBridgeRollout = config.ConfigProto.Experimental.MlirBridgeRollout.MLIR_BRIDGE_ROLLOUT_UNSPECIFIED
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 136 =>
            __mlirBridgeRollout = config.ConfigProto.Experimental.MlirBridgeRollout.fromValue(_input__.readEnum())
          case 128 =>
    ...
    implicit def messageReads: _root_.scalapb.descriptors.Reads[ConfigProto.Experimental] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        config.ConfigProto.Experimental(
          ...
          sessionMetadata = __fieldsMap.get(scalaDescriptor.findFieldByNumber(11).get).flatMap(_.as[_root_.scala.Option[SessionMetadata]]),
          ...
          mlirBridgeRollout = config.ConfigProto.Experimental.MlirBridgeRollout.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(17).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(config.ConfigProto.Experimental.MlirBridgeRollout.MLIR_BRIDGE_ROLLOUT_UNSPECIFIED.scalaValueDescriptor).number),
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = config.ConfigProto.javaDescriptor.getNestedTypes().get(1)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = config.ConfigProto.scalaDescriptor.nestedMessages(1)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
      var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
      (__number: @_root_.scala.unchecked) match {
        case 11 => __out = config.SessionMetadata
    ...
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        case 17 => config.ConfigProto.Experimental.MlirBridgeRollout
      }
    }
    lazy val defaultInstance = config.ConfigProto.Experimental(
      ...
      mlirBridgeRollout = config.ConfigProto.Experimental.MlirBridgeRollout.MLIR_BRIDGE_ROLLOUT_UNSPECIFIED,
    ...
    sealed abstract class MlirBridgeRollout(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
      type EnumType = ConfigProto.Experimental.MlirBridgeRollout
      type RecognizedType = ConfigProto.Experimental.MlirBridgeRollout.Recognized
      ...
      def companion: _root_.scalapb.GeneratedEnumCompanion[MlirBridgeRollout] = config.ConfigProto.Experimental.MlirBridgeRollout
      final def asRecognized: _root_.scala.Option[ConfigProto.Experimental.MlirBridgeRollout.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[ConfigProto.Experimental.MlirBridgeRollout.Recognized])
    }
    ...
    object MlirBridgeRollout extends _root_.scalapb.GeneratedEnumCompanion[MlirBridgeRollout] {
      ...
      def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = config.ConfigProto.Experimental.javaDescriptor.getEnumTypes().get(0)
      def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = config.ConfigProto.Experimental.scalaDescriptor.enums(0)
    }
    implicit class ExperimentalLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ConfigProto.Experimental]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ConfigProto.Experimental](_l) {
      ...
      def mlirBridgeRollout: _root_.scalapb.lenses.Lens[UpperPB, ConfigProto.Experimental.MlirBridgeRollout] = field(_.mlirBridgeRollout)((c_, f_) => c_.copy(mlirBridgeRollout = f_))
    ...
    def of(
            ...
            mlirBridgeRollout: ConfigProto.Experimental.MlirBridgeRollout,
    ...
    ): ConfigProto.Experimental = config.ConfigProto.Experimental(
      collectiveGroupLeader,
      executorType,
      recvBufMaxChunk,
      useNumaAffinity,
  ...
  implicit class ConfigProtoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ConfigProto]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ConfigProto](_l) {
    ...
    def sessionInterOpThreadPool: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[ThreadPoolOptionProto]] = field(_.sessionInterOpThreadPool)((c_, f_) => c_.copy(sessionInterOpThreadPool = f_))
    ...
    def gpuOptions: _root_.scalapb.lenses.Lens[UpperPB, GPUOptions] = field(_.getGpuOptions)((c_, f_) => c_.copy(gpuOptions = _root_.scala.Option(f_)))
    def optionalGpuOptions: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[GPUOptions]] = field(_.gpuOptions)((c_, f_) => c_.copy(gpuOptions = f_))
    def pluggableDeviceOptions: _root_.scalapb.lenses.Lens[UpperPB, GPUOptions] = field(_.getPluggableDeviceOptions)((c_, f_) => c_.copy(pluggableDeviceOptions = _root_.scala.Option(f_)))
    def optionalPluggableDeviceOptions: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[GPUOptions]] = field(_.pluggableDeviceOptions)((c_, f_) => c_.copy(pluggableDeviceOptions = f_))
    ...
    def graphOptions: _root_.scalapb.lenses.Lens[UpperPB, GraphOptions] = field(_.getGraphOptions)((c_, f_) => c_.copy(graphOptions = _root_.scala.Option(f_)))
    def optionalGraphOptions: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[GraphOptions]] = field(_.graphOptions)((c_, f_) => c_.copy(graphOptions = f_))
    ...
    def clusterDef: _root_.scalapb.lenses.Lens[UpperPB, ClusterDef] = field(_.getClusterDef)((c_, f_) => c_.copy(clusterDef = _root_.scala.Option(f_)))
    def optionalClusterDef: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[ClusterDef]] = field(_.clusterDef)((c_, f_) => c_.copy(clusterDef = f_))
    ...
    def shareClusterDevicesInSession: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Boolean] = field(_.shareClusterDevicesInSession)((c_, f_) => c_.copy(shareClusterDevicesInSession = f_))
    def experimental: _root_.scalapb.lenses.Lens[UpperPB, ConfigProto.Experimental] = field(_.getExperimental)((c_, f_) => c_.copy(experimental = _root_.scala.Option(f_)))
    def optionalExperimental: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[ConfigProto.Experimental]] = field(_.experimental)((c_, f_) => c_.copy(experimental = f_))
  }
  ...
  @transient
  private[config] val _typemapper_deviceCount: _root_.scalapb.TypeMapper[ConfigProto.DeviceCountEntry, (_root_.scala.Predef.String, _root_.scala.Int)] = implicitly[_root_.scalapb.TypeMapper[ConfigProto.DeviceCountEntry, (_root_.scala.Predef.String, _root_.scala.Int)]]
  def of(
