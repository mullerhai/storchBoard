...
final case class BatchingOptions(
    ...
    def companion: BatchingOptions.type = config.BatchingOptions
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.BatchingOptions])
}

object BatchingOptions extends scalapb.GeneratedMessageCompanion[BatchingOptions] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[BatchingOptions] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): BatchingOptions = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[BatchingOptions] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = BatchingOptions(
    numBatchThreads = 0,
    maxBatchSize = 0,
  ...
  implicit class BatchingOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, BatchingOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, BatchingOptions](_l) {
