...
final case class LogMessage(
    level: org.tensorflow.util.event.LogMessage.Level = org.tensorflow.util.event.LogMessage.Level.UNKNOWN,
    ...
    def withLevel(__v: org.tensorflow.util.event.LogMessage.Level): LogMessage = copy(level = __v)
    ...
    def companion: org.tensorflow.util.event.LogMessage.type = org.tensorflow.util.event.LogMessage
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.LogMessage])
}

@scala.deprecated(message="Marked as deprecated in proto file", "")
object LogMessage extends scalapb.GeneratedMessageCompanion[org.tensorflow.util.event.LogMessage] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.util.event.LogMessage] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.util.event.LogMessage = {
    var __level: org.tensorflow.util.event.LogMessage.Level = org.tensorflow.util.event.LogMessage.Level.UNKNOWN
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 8 =>
          __level = org.tensorflow.util.event.LogMessage.Level.fromValue(_input__.readEnum())
        case 18 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.util.event.LogMessage] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      org.tensorflow.util.event.LogMessage(
        level = org.tensorflow.util.event.LogMessage.Level.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(org.tensorflow.util.event.LogMessage.Level.UNKNOWN.scalaValueDescriptor).number),
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 1 => org.tensorflow.util.event.LogMessage.Level
    }
  }
  lazy val defaultInstance = org.tensorflow.util.event.LogMessage(
    level = org.tensorflow.util.event.LogMessage.Level.UNKNOWN,
    message = ""
  )
  @scala.deprecated(message="Marked as deprecated in proto file", "")
  @scala.deprecated(message="Marked as deprecated in proto file", "")
  sealed abstract class Level(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    type EnumType = org.tensorflow.util.event.LogMessage.Level
    type RecognizedType = org.tensorflow.util.event.LogMessage.Level.Recognized
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[Level] = org.tensorflow.util.event.LogMessage.Level
    final def asRecognized: _root_.scala.Option[org.tensorflow.util.event.LogMessage.Level.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[org.tensorflow.util.event.LogMessage.Level.Recognized])
  }
  ...
  object Level extends _root_.scalapb.GeneratedEnumCompanion[Level] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = org.tensorflow.util.event.LogMessage.javaDescriptor.getEnumTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = org.tensorflow.util.event.LogMessage.scalaDescriptor.enums(0)
  }
  implicit class LogMessageLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.util.event.LogMessage]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.util.event.LogMessage](_l) {
    def level: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.util.event.LogMessage.Level] = field(_.level)((c_, f_) => c_.copy(level = f_))
  ...
  def of(
    level: org.tensorflow.util.event.LogMessage.Level,
    message: _root_.scala.Predef.String
  ): _root_.org.tensorflow.util.event.LogMessage = _root_.org.tensorflow.util.event.LogMessage(
    level,
    message
  )
