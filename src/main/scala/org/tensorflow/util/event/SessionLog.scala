...
final case class SessionLog(
    status: org.tensorflow.util.event.SessionLog.SessionStatus = org.tensorflow.util.event.SessionLog.SessionStatus.STATUS_UNSPECIFIED,
    ...
    def withStatus(__v: org.tensorflow.util.event.SessionLog.SessionStatus): SessionLog = copy(status = __v)
    ...
    def companion: org.tensorflow.util.event.SessionLog.type = org.tensorflow.util.event.SessionLog
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.SessionLog])
}

object SessionLog extends scalapb.GeneratedMessageCompanion[org.tensorflow.util.event.SessionLog] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.util.event.SessionLog] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.util.event.SessionLog = {
    var __status: org.tensorflow.util.event.SessionLog.SessionStatus = org.tensorflow.util.event.SessionLog.SessionStatus.STATUS_UNSPECIFIED
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 8 =>
          __status = org.tensorflow.util.event.SessionLog.SessionStatus.fromValue(_input__.readEnum())
        case 18 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.util.event.SessionLog] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      org.tensorflow.util.event.SessionLog(
        status = org.tensorflow.util.event.SessionLog.SessionStatus.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(org.tensorflow.util.event.SessionLog.SessionStatus.STATUS_UNSPECIFIED.scalaValueDescriptor).number),
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 1 => org.tensorflow.util.event.SessionLog.SessionStatus
    }
  }
  lazy val defaultInstance = org.tensorflow.util.event.SessionLog(
    status = org.tensorflow.util.event.SessionLog.SessionStatus.STATUS_UNSPECIFIED,
    checkpointPath = "",
    msg = ""
  )
  sealed abstract class SessionStatus(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    type EnumType = org.tensorflow.util.event.SessionLog.SessionStatus
    type RecognizedType = org.tensorflow.util.event.SessionLog.SessionStatus.Recognized
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[SessionStatus] = org.tensorflow.util.event.SessionLog.SessionStatus
    final def asRecognized: _root_.scala.Option[org.tensorflow.util.event.SessionLog.SessionStatus.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[org.tensorflow.util.event.SessionLog.SessionStatus.Recognized])
  }
  ...
  object SessionStatus extends _root_.scalapb.GeneratedEnumCompanion[SessionStatus] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = org.tensorflow.util.event.SessionLog.javaDescriptor.getEnumTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = org.tensorflow.util.event.SessionLog.scalaDescriptor.enums(0)
  }
  implicit class SessionLogLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.util.event.SessionLog]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.util.event.SessionLog](_l) {
    def status: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.util.event.SessionLog.SessionStatus] = field(_.status)((c_, f_) => c_.copy(status = f_))
  ...
  def of(
    status: org.tensorflow.util.event.SessionLog.SessionStatus,
    checkpointPath: _root_.scala.Predef.String,
    msg: _root_.scala.Predef.String
  ): _root_.org.tensorflow.util.event.SessionLog = _root_.org.tensorflow.util.event.SessionLog(
    status,
    checkpointPath,
    msg
  )
