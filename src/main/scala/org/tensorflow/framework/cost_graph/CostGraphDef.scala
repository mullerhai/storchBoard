...
package org.tensorflow.framework.cost_graph

@SerialVersionUID(0L)
final case class CostGraphDef(
    node: _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node] = _root_.scala.Seq.empty,
    cost: _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost] = _root_.scala.Seq.empty,
    ...
    def addNode(__vs: org.tensorflow.framework.cost_graph.CostGraphDef.Node *): CostGraphDef = addAllNode(__vs)
    def addAllNode(__vs: Iterable[org.tensorflow.framework.cost_graph.CostGraphDef.Node]): CostGraphDef = copy(node = node ++ __vs)
    def withNode(__v: _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node]): CostGraphDef = copy(node = __v)
    def clearCost = copy(cost = _root_.scala.Seq.empty)
    def addCost(__vs: org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost *): CostGraphDef = addAllCost(__vs)
    def addAllCost(__vs: Iterable[org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost]): CostGraphDef = copy(cost = cost ++ __vs)
    def withCost(__v: _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost]): CostGraphDef = copy(cost = __v)
    ...
    def companion: org.tensorflow.framework.cost_graph.CostGraphDef.type = org.tensorflow.framework.cost_graph.CostGraphDef
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.CostGraphDef])
}

object CostGraphDef extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.cost_graph.CostGraphDef] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.cost_graph.CostGraphDef] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.cost_graph.CostGraphDef = {
    val __node: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.cost_graph.CostGraphDef.Node] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.cost_graph.CostGraphDef.Node]
    val __cost: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost]
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 10 =>
          __node += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.cost_graph.CostGraphDef.Node](_input__)
        case 18 =>
          __cost += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost](_input__)
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.cost_graph.CostGraphDef] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      org.tensorflow.framework.cost_graph.CostGraphDef(
        node = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node]]).getOrElse(_root_.scala.Seq.empty),
        cost = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost]]).getOrElse(_root_.scala.Seq.empty)
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 1 => __out = org.tensorflow.framework.cost_graph.CostGraphDef.Node
      case 2 => __out = org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]](
      _root_.org.tensorflow.framework.cost_graph.CostGraphDef.Node,
      _root_.org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost
    )
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
  lazy val defaultInstance = org.tensorflow.framework.cost_graph.CostGraphDef(
  ...
  final case class Node(
      ...
      inputInfo: _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo] = _root_.scala.Seq.empty,
      outputInfo: _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo] = _root_.scala.Seq.empty,
      ...
      def addInputInfo(__vs: org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo *): Node = addAllInputInfo(__vs)
      def addAllInputInfo(__vs: Iterable[org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo]): Node = copy(inputInfo = inputInfo ++ __vs)
      def withInputInfo(__v: _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo]): Node = copy(inputInfo = __v)
      def clearOutputInfo = copy(outputInfo = _root_.scala.Seq.empty)
      def addOutputInfo(__vs: org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo *): Node = addAllOutputInfo(__vs)
      def addAllOutputInfo(__vs: Iterable[org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo]): Node = copy(outputInfo = outputInfo ++ __vs)
      def withOutputInfo(__v: _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo]): Node = copy(outputInfo = __v)
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.cost_graph.CostGraphDef.Node.type = org.tensorflow.framework.cost_graph.CostGraphDef.Node
      // @@protoc_insertion_point(GeneratedMessage[tensorboard.CostGraphDef.Node])
  }
  
  object Node extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.cost_graph.CostGraphDef.Node] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.cost_graph.CostGraphDef.Node] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.cost_graph.CostGraphDef.Node = {
      var __name: _root_.scala.Predef.String = ""
      var __device: _root_.scala.Predef.String = ""
      var __id: _root_.scala.Int = 0
      val __inputInfo: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo]
      val __outputInfo: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo]
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 34 =>
            __inputInfo += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo](_input__)
          case 42 =>
            __outputInfo += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo](_input__)
          case 48 =>
      ...
      org.tensorflow.framework.cost_graph.CostGraphDef.Node(
          name = __name,
          device = __device,
          id = __id,
    ...
    implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.cost_graph.CostGraphDef.Node] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        org.tensorflow.framework.cost_graph.CostGraphDef.Node(
          ...
          inputInfo = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo]]).getOrElse(_root_.scala.Seq.empty),
          outputInfo = __fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo]]).getOrElse(_root_.scala.Seq.empty),
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.cost_graph.CostGraphDef.javaDescriptor.getNestedTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.cost_graph.CostGraphDef.scalaDescriptor.nestedMessages(0)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
      var __out: _root_.scalapb.GeneratedMessageCompanion[?]= null
      (__number: @_root_.scala.unchecked) match {
        case 4 => __out = org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo
        case 5 => __out = org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo
      }
      __out
    }
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] =
      Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]](
        _root_.org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo,
        _root_.org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo
      )
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
    lazy val defaultInstance = org.tensorflow.framework.cost_graph.CostGraphDef.Node(
      name = "",
      device = "",
      id = 0,
    ...
    final case class InputInfo(
        ...
        def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
        def companion: org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo.type = org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo
        // @@protoc_insertion_point(GeneratedMessage[tensorboard.CostGraphDef.Node.InputInfo])
    }
    
    object InputInfo extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo] {
      implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo] = this
      def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo = {
        ...
        org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo(
            precedingNode = __precedingNode,
            precedingPort = __precedingPort,
            unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
        )
      }
      implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo] = _root_.scalapb.descriptors.Reads{
        case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
          _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
          org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo(
      ...
      def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.cost_graph.CostGraphDef.Node.javaDescriptor.getNestedTypes().get(0)
      def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.cost_graph.CostGraphDef.Node.scalaDescriptor.nestedMessages(0)
      def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= throw new MatchError(__number)
      lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
      def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
      lazy val defaultInstance = org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo(
        precedingNode = 0,
        precedingPort = 0
      )
      implicit class InputInfoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo](_l) {
      ...
      ): _root_.org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo = _root_.org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo(
        precedingNode,
        precedingPort
      )
    ...
    final case class OutputInfo(
        ...
        def withShape(__v: org.tensorflow.framework.tensor_shape.TensorShapeProto): OutputInfo = copy(shape = Option(__v))
        def withDtype(__v: org.tensorflow.framework.types.DataType): OutputInfo = copy(dtype = __v)
        def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
        def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
        def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
          (__fieldNumber: @_root_.scala.unchecked) match {
        ...
        def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
        def companion: org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo.type = org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo
        // @@protoc_insertion_point(GeneratedMessage[tensorboard.CostGraphDef.Node.OutputInfo])
    }
    
    object OutputInfo extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo] {
      implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo] = this
      def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo = {
        ...
        org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo(
            size = __size,
      ...
      implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo] = _root_.scalapb.descriptors.Reads{
        case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
          _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
          org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo(
            ...
            shape = __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).flatMap(_.as[_root_.scala.Option[org.tensorflow.framework.tensor_shape.TensorShapeProto]]),
            dtype = org.tensorflow.framework.types.DataType.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(org.tensorflow.framework.types.DataType.DT_INVALID.scalaValueDescriptor).number)
          )
        case _ => throw new RuntimeException("Expected PMessage")
      }
      def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.cost_graph.CostGraphDef.Node.javaDescriptor.getNestedTypes().get(1)
      def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.cost_graph.CostGraphDef.Node.scalaDescriptor.nestedMessages(1)
      def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
        var __out: _root_.scalapb.GeneratedMessageCompanion[?]= null
        (__number: @_root_.scala.unchecked) match {
      ...
      def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= {
        (__fieldNumber: @_root_.scala.unchecked) match {
          case 4 => org.tensorflow.framework.types.DataType
        }
      }
      lazy val defaultInstance = org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo(
        size = 0L,
        aliasInputPort = 0L,
        shape = _root_.scala.None,
        dtype = org.tensorflow.framework.types.DataType.DT_INVALID
      )
      implicit class OutputInfoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo](_l) {
      ...
      ): _root_.org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo = _root_.org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo(
        size,
        aliasInputPort,
        shape,
        dtype
    ...
    implicit class NodeLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.cost_graph.CostGraphDef.Node]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.cost_graph.CostGraphDef.Node](_l) {
      ...
      def inputInfo: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo]] = field(_.inputInfo)((c_, f_) => c_.copy(inputInfo = f_))
      def outputInfo: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo]] = field(_.outputInfo)((c_, f_) => c_.copy(outputInfo = f_))
    ...
    def of(
      ...
      device: _root_.scala.Predef.String,
      id: _root_.scala.Int,
      inputInfo: _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node.InputInfo],
      outputInfo: _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node.OutputInfo],
    ...
    ): _root_.org.tensorflow.framework.cost_graph.CostGraphDef.Node = _root_.org.tensorflow.framework.cost_graph.CostGraphDef.Node(
      name,
      device,
      id,
      inputInfo,
  ...
  final case class AggregatedCost(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost.type = org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost
      // @@protoc_insertion_point(GeneratedMessage[tensorboard.CostGraphDef.AggregatedCost])
  }
  
  object AggregatedCost extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost = {
      ...
      org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost(
          cost = __cost,
          dimension = __dimension,
          unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
      )
    }
    implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost(
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.cost_graph.CostGraphDef.javaDescriptor.getNestedTypes().get(1)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.cost_graph.CostGraphDef.scalaDescriptor.nestedMessages(1)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= throw new MatchError(__number)
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
    lazy val defaultInstance = org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost(
      cost = 0.0f,
      dimension = ""
    )
    implicit class AggregatedCostLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost](_l) {
    ...
    def of(
      ...
      dimension: _root_.scala.Predef.String
    ): _root_.org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost = _root_.org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost(
      cost,
      dimension
    )
  ...
  implicit class CostGraphDefLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.cost_graph.CostGraphDef]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.cost_graph.CostGraphDef](_l) {
    def node: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node]] = field(_.node)((c_, f_) => c_.copy(node = f_))
    def cost: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost]] = field(_.cost)((c_, f_) => c_.copy(cost = f_))
  }
  final val NODE_FIELD_NUMBER = 1
  final val COST_FIELD_NUMBER = 2
  def of(
    node: _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.Node],
    cost: _root_.scala.Seq[org.tensorflow.framework.cost_graph.CostGraphDef.AggregatedCost]
  ): _root_.org.tensorflow.framework.cost_graph.CostGraphDef = _root_.org.tensorflow.framework.cost_graph.CostGraphDef(
    node,
    cost
  )
