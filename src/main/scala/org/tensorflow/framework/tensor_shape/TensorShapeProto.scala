...
final case class TensorShapeProto(
    ...
    def companion: org.tensorflow.framework.tensor_shape.TensorShapeProto.type = org.tensorflow.framework.tensor_shape.TensorShapeProto
...
object TensorShapeProto extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.tensor_shape.TensorShapeProto] {
  ...
  final case class Dim(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.tensor_shape.TensorShapeProto.Dim.type = org.tensorflow.framework.tensor_shape.TensorShapeProto.Dim
