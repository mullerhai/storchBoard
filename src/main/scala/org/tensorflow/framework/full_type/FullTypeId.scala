...
sealed abstract class FullTypeId(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
  type EnumType = org.tensorflow.framework.full_type.FullTypeId
  type RecognizedType = org.tensorflow.framework.full_type.FullTypeId.Recognized
  ...
  def companion: _root_.scalapb.GeneratedEnumCompanion[FullTypeId] = org.tensorflow.framework.full_type.FullTypeId
  final def asRecognized: _root_.scala.Option[org.tensorflow.framework.full_type.FullTypeId.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[org.tensorflow.framework.full_type.FullTypeId.Recognized])
}
