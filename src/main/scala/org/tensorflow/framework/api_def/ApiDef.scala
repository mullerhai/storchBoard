...
package org.tensorflow.framework.api_def
...
final case class ApiDef(
    ...
    visibility: org.tensorflow.framework.api_def.ApiDef.Visibility = org.tensorflow.framework.api_def.ApiDef.Visibility.DEFAULT_VISIBILITY,
    endpoint: _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Endpoint] = _root_.scala.Seq.empty,
    inArg: _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Arg] = _root_.scala.Seq.empty,
    outArg: _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Arg] = _root_.scala.Seq.empty,
    argOrder: _root_.scala.Seq[_root_.scala.Predef.String] = _root_.scala.Seq.empty,
    attr: _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Attr] = _root_.scala.Seq.empty,
    ...
    def withVisibility(__v: org.tensorflow.framework.api_def.ApiDef.Visibility): ApiDef = copy(visibility = __v)
    def clearEndpoint = copy(endpoint = _root_.scala.Seq.empty)
    def addEndpoint(__vs: org.tensorflow.framework.api_def.ApiDef.Endpoint *): ApiDef = addAllEndpoint(__vs)
    def addAllEndpoint(__vs: Iterable[org.tensorflow.framework.api_def.ApiDef.Endpoint]): ApiDef = copy(endpoint = endpoint ++ __vs)
    def withEndpoint(__v: _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Endpoint]): ApiDef = copy(endpoint = __v)
    def clearInArg = copy(inArg = _root_.scala.Seq.empty)
    def addInArg(__vs: org.tensorflow.framework.api_def.ApiDef.Arg *): ApiDef = addAllInArg(__vs)
    def addAllInArg(__vs: Iterable[org.tensorflow.framework.api_def.ApiDef.Arg]): ApiDef = copy(inArg = inArg ++ __vs)
    def withInArg(__v: _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Arg]): ApiDef = copy(inArg = __v)
    def clearOutArg = copy(outArg = _root_.scala.Seq.empty)
    def addOutArg(__vs: org.tensorflow.framework.api_def.ApiDef.Arg *): ApiDef = addAllOutArg(__vs)
    def addAllOutArg(__vs: Iterable[org.tensorflow.framework.api_def.ApiDef.Arg]): ApiDef = copy(outArg = outArg ++ __vs)
    def withOutArg(__v: _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Arg]): ApiDef = copy(outArg = __v)
    ...
    def addAttr(__vs: org.tensorflow.framework.api_def.ApiDef.Attr *): ApiDef = addAllAttr(__vs)
    def addAllAttr(__vs: Iterable[org.tensorflow.framework.api_def.ApiDef.Attr]): ApiDef = copy(attr = attr ++ __vs)
    def withAttr(__v: _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Attr]): ApiDef = copy(attr = __v)
    ...
    def companion: org.tensorflow.framework.api_def.ApiDef.type = org.tensorflow.framework.api_def.ApiDef
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.ApiDef])
}

object ApiDef extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.api_def.ApiDef] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.api_def.ApiDef] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.api_def.ApiDef = {
    ...
    var __visibility: org.tensorflow.framework.api_def.ApiDef.Visibility = org.tensorflow.framework.api_def.ApiDef.Visibility.DEFAULT_VISIBILITY
    val __endpoint: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.api_def.ApiDef.Endpoint] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.api_def.ApiDef.Endpoint]
    val __inArg: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.api_def.ApiDef.Arg] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.api_def.ApiDef.Arg]
    val __outArg: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.api_def.ApiDef.Arg] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.api_def.ApiDef.Arg]
    ...
    val __attr: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.api_def.ApiDef.Attr] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.api_def.ApiDef.Attr]
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 16 =>
          __visibility = org.tensorflow.framework.api_def.ApiDef.Visibility.fromValue(_input__.readEnum())
        case 26 =>
          __endpoint += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.api_def.ApiDef.Endpoint](_input__)
        case 34 =>
          __inArg += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.api_def.ApiDef.Arg](_input__)
        case 42 =>
          __outArg += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.api_def.ApiDef.Arg](_input__)
        case 90 =>
          __argOrder += _input__.readStringRequireUtf8()
        case 50 =>
          __attr += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.api_def.ApiDef.Attr](_input__)
        case 58 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.api_def.ApiDef] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      org.tensorflow.framework.api_def.ApiDef(
        ...
        visibility = org.tensorflow.framework.api_def.ApiDef.Visibility.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(org.tensorflow.framework.api_def.ApiDef.Visibility.DEFAULT_VISIBILITY.scalaValueDescriptor).number),
        endpoint = __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Endpoint]]).getOrElse(_root_.scala.Seq.empty),
        inArg = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Arg]]).getOrElse(_root_.scala.Seq.empty),
        outArg = __fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Arg]]).getOrElse(_root_.scala.Seq.empty),
        ...
        attr = __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Attr]]).getOrElse(_root_.scala.Seq.empty),
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 3 => __out = org.tensorflow.framework.api_def.ApiDef.Endpoint
      case 4 => __out = org.tensorflow.framework.api_def.ApiDef.Arg
      case 5 => __out = org.tensorflow.framework.api_def.ApiDef.Arg
      case 6 => __out = org.tensorflow.framework.api_def.ApiDef.Attr
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]](
      _root_.org.tensorflow.framework.api_def.ApiDef.Endpoint,
      _root_.org.tensorflow.framework.api_def.ApiDef.Arg,
      _root_.org.tensorflow.framework.api_def.ApiDef.Attr
    )
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 2 => org.tensorflow.framework.api_def.ApiDef.Visibility
    }
  }
  lazy val defaultInstance = org.tensorflow.framework.api_def.ApiDef(
    graphOpName = "",
    deprecationMessage = "",
    deprecationVersion = 0,
    visibility = org.tensorflow.framework.api_def.ApiDef.Visibility.DEFAULT_VISIBILITY,
  ...
  sealed abstract class Visibility(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    type EnumType = org.tensorflow.framework.api_def.ApiDef.Visibility
    type RecognizedType = org.tensorflow.framework.api_def.ApiDef.Visibility.Recognized
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[Visibility] = org.tensorflow.framework.api_def.ApiDef.Visibility
    final def asRecognized: _root_.scala.Option[org.tensorflow.framework.api_def.ApiDef.Visibility.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[org.tensorflow.framework.api_def.ApiDef.Visibility.Recognized])
  }
  ...
  object Visibility extends _root_.scalapb.GeneratedEnumCompanion[Visibility] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = org.tensorflow.framework.api_def.ApiDef.javaDescriptor.getEnumTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = org.tensorflow.framework.api_def.ApiDef.scalaDescriptor.enums(0)
  }
  ...
  final case class Endpoint(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.api_def.ApiDef.Endpoint.type = org.tensorflow.framework.api_def.ApiDef.Endpoint
      // @@protoc_insertion_point(GeneratedMessage[tensorboard.ApiDef.Endpoint])
  }
  
  object Endpoint extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.api_def.ApiDef.Endpoint] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.api_def.ApiDef.Endpoint] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.api_def.ApiDef.Endpoint = {
      ...
      org.tensorflow.framework.api_def.ApiDef.Endpoint(
          name = __name,
    ...
    implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.api_def.ApiDef.Endpoint] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        org.tensorflow.framework.api_def.ApiDef.Endpoint(
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.api_def.ApiDef.javaDescriptor.getNestedTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.api_def.ApiDef.scalaDescriptor.nestedMessages(0)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= throw new MatchError(__number)
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
    lazy val defaultInstance = org.tensorflow.framework.api_def.ApiDef.Endpoint(
      name = "",
      deprecated = false,
      deprecationVersion = 0
    )
    implicit class EndpointLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.api_def.ApiDef.Endpoint]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.api_def.ApiDef.Endpoint](_l) {
    ...
    ): _root_.org.tensorflow.framework.api_def.ApiDef.Endpoint = _root_.org.tensorflow.framework.api_def.ApiDef.Endpoint(
      name,
      deprecated,
      deprecationVersion
    )
  ...
  final case class Arg(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.api_def.ApiDef.Arg.type = org.tensorflow.framework.api_def.ApiDef.Arg
      // @@protoc_insertion_point(GeneratedMessage[tensorboard.ApiDef.Arg])
  }
  
  object Arg extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.api_def.ApiDef.Arg] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.api_def.ApiDef.Arg] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.api_def.ApiDef.Arg = {
      var __name: _root_.scala.Predef.String = ""
      ...
      org.tensorflow.framework.api_def.ApiDef.Arg(
          name = __name,
          renameTo = __renameTo,
          description = __description,
          unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
    ...
    implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.api_def.ApiDef.Arg] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        org.tensorflow.framework.api_def.ApiDef.Arg(
          name = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.api_def.ApiDef.javaDescriptor.getNestedTypes().get(1)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.api_def.ApiDef.scalaDescriptor.nestedMessages(1)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= throw new MatchError(__number)
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
    lazy val defaultInstance = org.tensorflow.framework.api_def.ApiDef.Arg(
      name = "",
      renameTo = "",
      description = ""
    )
    implicit class ArgLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.api_def.ApiDef.Arg]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.api_def.ApiDef.Arg](_l) {
      def name: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.name)((c_, f_) => c_.copy(name = f_))
    ...
    def of(
      ...
      renameTo: _root_.scala.Predef.String,
      description: _root_.scala.Predef.String
    ): _root_.org.tensorflow.framework.api_def.ApiDef.Arg = _root_.org.tensorflow.framework.api_def.ApiDef.Arg(
      name,
      renameTo,
      description
    )
  ...
  final case class Attr(
      ...
      def withDefaultValue(__v: org.tensorflow.framework.attr_value.AttrValue): Attr = copy(defaultValue = Option(__v))
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.api_def.ApiDef.Attr.type = org.tensorflow.framework.api_def.ApiDef.Attr
      // @@protoc_insertion_point(GeneratedMessage[tensorboard.ApiDef.Attr])
  }
  
  object Attr extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.api_def.ApiDef.Attr] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.api_def.ApiDef.Attr] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.api_def.ApiDef.Attr = {
      var __name: _root_.scala.Predef.String = ""
      var __renameTo: _root_.scala.Predef.String = ""
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 18 =>
            __renameTo = _input__.readStringRequireUtf8()
          case 26 =>
            __defaultValue = _root_.scala.Option(__defaultValue.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.attr_value.AttrValue](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
          case 34 =>
            __description = _input__.readStringRequireUtf8()
          case tag =>
            if (_unknownFields__ == null) {
      ...
      org.tensorflow.framework.api_def.ApiDef.Attr(
          name = __name,
          renameTo = __renameTo,
    ...
    implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.api_def.ApiDef.Attr] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        org.tensorflow.framework.api_def.ApiDef.Attr(
          name = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.api_def.ApiDef.javaDescriptor.getNestedTypes().get(2)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.api_def.ApiDef.scalaDescriptor.nestedMessages(2)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
      var __out: _root_.scalapb.GeneratedMessageCompanion[?]= null
      (__number: @_root_.scala.unchecked) match {
    ...
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
    lazy val defaultInstance = org.tensorflow.framework.api_def.ApiDef.Attr(
      name = "",
      renameTo = "",
      defaultValue = _root_.scala.None,
      description = ""
    )
    implicit class AttrLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.api_def.ApiDef.Attr]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.api_def.ApiDef.Attr](_l) {
      def name: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.name)((c_, f_) => c_.copy(name = f_))
      def renameTo: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.renameTo)((c_, f_) => c_.copy(renameTo = f_))
      def defaultValue: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.attr_value.AttrValue] = field(_.getDefaultValue)((c_, f_) => c_.copy(defaultValue = _root_.scala.Option(f_)))
    ...
    def of(
      ...
      description: _root_.scala.Predef.String
    ): _root_.org.tensorflow.framework.api_def.ApiDef.Attr = _root_.org.tensorflow.framework.api_def.ApiDef.Attr(
      name,
      renameTo,
      defaultValue,
      description
  ...
  implicit class ApiDefLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.api_def.ApiDef]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.api_def.ApiDef](_l) {
    ...
    def deprecationVersion: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Int] = field(_.deprecationVersion)((c_, f_) => c_.copy(deprecationVersion = f_))
    def visibility: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.api_def.ApiDef.Visibility] = field(_.visibility)((c_, f_) => c_.copy(visibility = f_))
    def endpoint: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Endpoint]] = field(_.endpoint)((c_, f_) => c_.copy(endpoint = f_))
    def inArg: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Arg]] = field(_.inArg)((c_, f_) => c_.copy(inArg = f_))
    def outArg: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Arg]] = field(_.outArg)((c_, f_) => c_.copy(outArg = f_))
    ...
    def attr: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Attr]] = field(_.attr)((c_, f_) => c_.copy(attr = f_))
  ...
  def of(
    ...
    deprecationMessage: _root_.scala.Predef.String,
    deprecationVersion: _root_.scala.Int,
    visibility: org.tensorflow.framework.api_def.ApiDef.Visibility,
    endpoint: _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Endpoint],
    inArg: _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Arg],
    outArg: _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Arg],
    argOrder: _root_.scala.Seq[_root_.scala.Predef.String],
    attr: _root_.scala.Seq[org.tensorflow.framework.api_def.ApiDef.Attr],
    summary: _root_.scala.Predef.String,
    description: _root_.scala.Predef.String,
    descriptionPrefix: _root_.scala.Predef.String,
    descriptionSuffix: _root_.scala.Predef.String
  ): _root_.org.tensorflow.framework.api_def.ApiDef = _root_.org.tensorflow.framework.api_def.ApiDef(
    graphOpName,
    deprecationMessage,
    deprecationVersion,
    visibility,
