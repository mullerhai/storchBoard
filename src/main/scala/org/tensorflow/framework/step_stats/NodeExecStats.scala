...
final case class NodeExecStats(
    ...
    memory: _root_.scala.Seq[org.tensorflow.framework.step_stats.AllocatorMemoryUsed] = _root_.scala.Seq.empty,
    output: _root_.scala.Seq[org.tensorflow.framework.step_stats.NodeOutput] = _root_.scala.Seq.empty,
    timelineLabel: _root_.scala.Predef.String = "",
    scheduledMicros: _root_.scala.Long = 0L,
    threadId: _root_.scala.Int = 0,
    referencedTensor: _root_.scala.Seq[org.tensorflow.framework.allocation_description.AllocationDescription] = _root_.scala.Seq.empty,
    memoryStats: _root_.scala.Option[org.tensorflow.framework.step_stats.MemoryStats] = _root_.scala.None,
    ...
    def addMemory(__vs: org.tensorflow.framework.step_stats.AllocatorMemoryUsed *): NodeExecStats = addAllMemory(__vs)
    def addAllMemory(__vs: Iterable[org.tensorflow.framework.step_stats.AllocatorMemoryUsed]): NodeExecStats = copy(memory = memory ++ __vs)
    def withMemory(__v: _root_.scala.Seq[org.tensorflow.framework.step_stats.AllocatorMemoryUsed]): NodeExecStats = copy(memory = __v)
    def clearOutput = copy(output = _root_.scala.Seq.empty)
    def addOutput(__vs: org.tensorflow.framework.step_stats.NodeOutput *): NodeExecStats = addAllOutput(__vs)
    def addAllOutput(__vs: Iterable[org.tensorflow.framework.step_stats.NodeOutput]): NodeExecStats = copy(output = output ++ __vs)
    def withOutput(__v: _root_.scala.Seq[org.tensorflow.framework.step_stats.NodeOutput]): NodeExecStats = copy(output = __v)
    ...
    def addReferencedTensor(__vs: org.tensorflow.framework.allocation_description.AllocationDescription *): NodeExecStats = addAllReferencedTensor(__vs)
    def addAllReferencedTensor(__vs: Iterable[org.tensorflow.framework.allocation_description.AllocationDescription]): NodeExecStats = copy(referencedTensor = referencedTensor ++ __vs)
    def withReferencedTensor(__v: _root_.scala.Seq[org.tensorflow.framework.allocation_description.AllocationDescription]): NodeExecStats = copy(referencedTensor = __v)
    def getMemoryStats: org.tensorflow.framework.step_stats.MemoryStats = memoryStats.getOrElse(org.tensorflow.framework.step_stats.MemoryStats.defaultInstance)
    def clearMemoryStats: NodeExecStats = copy(memoryStats = _root_.scala.None)
    def withMemoryStats(__v: org.tensorflow.framework.step_stats.MemoryStats): NodeExecStats = copy(memoryStats = Option(__v))
    ...
    def companion: org.tensorflow.framework.step_stats.NodeExecStats.type = org.tensorflow.framework.step_stats.NodeExecStats
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.NodeExecStats])
}

object NodeExecStats extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.step_stats.NodeExecStats] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.step_stats.NodeExecStats] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.step_stats.NodeExecStats = {
    ...
    val __memory: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.step_stats.AllocatorMemoryUsed] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.step_stats.AllocatorMemoryUsed]
    val __output: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.step_stats.NodeOutput] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.step_stats.NodeOutput]
    ...
    val __referencedTensor: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.allocation_description.AllocationDescription] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.allocation_description.AllocationDescription]
    var __memoryStats: _root_.scala.Option[org.tensorflow.framework.step_stats.MemoryStats] = _root_.scala.None
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 50 =>
          __memory += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.step_stats.AllocatorMemoryUsed](_input__)
        case 58 =>
          __output += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.step_stats.NodeOutput](_input__)
        case 66 =>
        ...
        case 90 =>
          __referencedTensor += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.allocation_description.AllocationDescription](_input__)
        case 98 =>
          __memoryStats = _root_.scala.Option(__memoryStats.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.step_stats.MemoryStats](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 104 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.step_stats.NodeExecStats] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      org.tensorflow.framework.step_stats.NodeExecStats(
        ...
        memory = __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.step_stats.AllocatorMemoryUsed]]).getOrElse(_root_.scala.Seq.empty),
        output = __fieldsMap.get(scalaDescriptor.findFieldByNumber(7).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.step_stats.NodeOutput]]).getOrElse(_root_.scala.Seq.empty),
        ...
        referencedTensor = __fieldsMap.get(scalaDescriptor.findFieldByNumber(11).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.allocation_description.AllocationDescription]]).getOrElse(_root_.scala.Seq.empty),
        memoryStats = __fieldsMap.get(scalaDescriptor.findFieldByNumber(12).get).flatMap(_.as[_root_.scala.Option[org.tensorflow.framework.step_stats.MemoryStats]]),
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 6 => __out = org.tensorflow.framework.step_stats.AllocatorMemoryUsed
      case 7 => __out = org.tensorflow.framework.step_stats.NodeOutput
      case 11 => __out = org.tensorflow.framework.allocation_description.AllocationDescription
      case 12 => __out = org.tensorflow.framework.step_stats.MemoryStats
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
  lazy val defaultInstance = org.tensorflow.framework.step_stats.NodeExecStats(
    nodeName = "",
    allStartMicros = 0L,
    opStartRelMicros = 0L,
    opEndRelMicros = 0L,
  ...
  implicit class NodeExecStatsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.step_stats.NodeExecStats]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.step_stats.NodeExecStats](_l) {
    ...
    def memory: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.step_stats.AllocatorMemoryUsed]] = field(_.memory)((c_, f_) => c_.copy(memory = f_))
    def output: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.step_stats.NodeOutput]] = field(_.output)((c_, f_) => c_.copy(output = f_))
    ...
    def referencedTensor: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.allocation_description.AllocationDescription]] = field(_.referencedTensor)((c_, f_) => c_.copy(referencedTensor = f_))
    def memoryStats: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.step_stats.MemoryStats] = field(_.getMemoryStats)((c_, f_) => c_.copy(memoryStats = _root_.scala.Option(f_)))
    def optionalMemoryStats: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[org.tensorflow.framework.step_stats.MemoryStats]] = field(_.memoryStats)((c_, f_) => c_.copy(memoryStats = f_))
  ...
  def of(
    ...
    memory: _root_.scala.Seq[org.tensorflow.framework.step_stats.AllocatorMemoryUsed],
    output: _root_.scala.Seq[org.tensorflow.framework.step_stats.NodeOutput],
    timelineLabel: _root_.scala.Predef.String,
    scheduledMicros: _root_.scala.Long,
    threadId: _root_.scala.Int,
    referencedTensor: _root_.scala.Seq[org.tensorflow.framework.allocation_description.AllocationDescription],
    memoryStats: _root_.scala.Option[org.tensorflow.framework.step_stats.MemoryStats],
  ...
  ): _root_.org.tensorflow.framework.step_stats.NodeExecStats = _root_.org.tensorflow.framework.step_stats.NodeExecStats(
    nodeName,
    allStartMicros,
    opStartRelMicros,
    opEndRelMicros,
