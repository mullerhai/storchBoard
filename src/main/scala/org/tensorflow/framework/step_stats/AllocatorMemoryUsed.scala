...
final case class AllocatorMemoryUsed(
    ...
    allocationRecords: _root_.scala.Seq[org.tensorflow.framework.step_stats.AllocationRecord] = _root_.scala.Seq.empty,
    ...
    def addAllocationRecords(__vs: org.tensorflow.framework.step_stats.AllocationRecord *): AllocatorMemoryUsed = addAllAllocationRecords(__vs)
    def addAllAllocationRecords(__vs: Iterable[org.tensorflow.framework.step_stats.AllocationRecord]): AllocatorMemoryUsed = copy(allocationRecords = allocationRecords ++ __vs)
    def withAllocationRecords(__v: _root_.scala.Seq[org.tensorflow.framework.step_stats.AllocationRecord]): AllocatorMemoryUsed = copy(allocationRecords = __v)
    ...
    def companion: org.tensorflow.framework.step_stats.AllocatorMemoryUsed.type = org.tensorflow.framework.step_stats.AllocatorMemoryUsed
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.AllocatorMemoryUsed])
}

object AllocatorMemoryUsed extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.step_stats.AllocatorMemoryUsed] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.step_stats.AllocatorMemoryUsed] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.step_stats.AllocatorMemoryUsed = {
    ...
    val __allocationRecords: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.step_stats.AllocationRecord] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.step_stats.AllocationRecord]
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 50 =>
          __allocationRecords += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.step_stats.AllocationRecord](_input__)
        case 40 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.step_stats.AllocatorMemoryUsed] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      org.tensorflow.framework.step_stats.AllocatorMemoryUsed(
        ...
        allocationRecords = __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.step_stats.AllocationRecord]]).getOrElse(_root_.scala.Seq.empty),
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 6 => __out = org.tensorflow.framework.step_stats.AllocationRecord
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
  lazy val defaultInstance = org.tensorflow.framework.step_stats.AllocatorMemoryUsed(
    allocatorName = "",
    totalBytes = 0L,
    peakBytes = 0L,
    liveBytes = 0L,
  ...
  implicit class AllocatorMemoryUsedLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.step_stats.AllocatorMemoryUsed]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.step_stats.AllocatorMemoryUsed](_l) {
    ...
    def allocationRecords: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.step_stats.AllocationRecord]] = field(_.allocationRecords)((c_, f_) => c_.copy(allocationRecords = f_))
  ...
  def of(
    ...
    allocationRecords: _root_.scala.Seq[org.tensorflow.framework.step_stats.AllocationRecord],
    allocatorBytesInUse: _root_.scala.Long
  ): _root_.org.tensorflow.framework.step_stats.AllocatorMemoryUsed = _root_.org.tensorflow.framework.step_stats.AllocatorMemoryUsed(
    allocatorName,
    totalBytes,
    peakBytes,
    liveBytes,
