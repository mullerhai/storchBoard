...
final case class ResourceHandleProto(
    ...
    dtypesAndShapes: _root_.scala.Seq[org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape] = _root_.scala.Seq.empty,
    ...
    def addDtypesAndShapes(__vs: org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape *): ResourceHandleProto = addAllDtypesAndShapes(__vs)
    def addAllDtypesAndShapes(__vs: Iterable[org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape]): ResourceHandleProto = copy(dtypesAndShapes = dtypesAndShapes ++ __vs)
    def withDtypesAndShapes(__v: _root_.scala.Seq[org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape]): ResourceHandleProto = copy(dtypesAndShapes = __v)
    ...
    def companion: org.tensorflow.framework.resource_handle.ResourceHandleProto.type = org.tensorflow.framework.resource_handle.ResourceHandleProto
...
object ResourceHandleProto extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.resource_handle.ResourceHandleProto] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.resource_handle.ResourceHandleProto = {
    ...
    val __dtypesAndShapes: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape]
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 50 =>
          __dtypesAndShapes += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape](_input__)
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.resource_handle.ResourceHandleProto] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      org.tensorflow.framework.resource_handle.ResourceHandleProto(
        ...
        dtypesAndShapes = __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape]]).getOrElse(_root_.scala.Seq.empty)
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 6 => __out = org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]](
      _root_.org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape
    )
  ...
  final case class DtypeAndShape(
      ...
      def withDtype(__v: org.tensorflow.framework.types.DataType): DtypeAndShape = copy(dtype = __v)
      ...
      def withShape(__v: org.tensorflow.framework.tensor_shape.TensorShapeProto): DtypeAndShape = copy(shape = Option(__v))
      def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
      def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
      def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
        (__fieldNumber: @_root_.scala.unchecked) match {
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape.type = org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape
      // @@protoc_insertion_point(GeneratedMessage[tensorboard.ResourceHandleProto.DtypeAndShape])
  }
  
  object DtypeAndShape extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape = {
      ...
      org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape(
          dtype = __dtype,
          shape = __shape,
          unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
      )
    }
    implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape(
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.resource_handle.ResourceHandleProto.javaDescriptor.getNestedTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.resource_handle.ResourceHandleProto.scalaDescriptor.nestedMessages(0)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?] = {
      var __out: _root_.scalapb.GeneratedMessageCompanion[?] = null
      (__number: @_root_.scala.unchecked) match {
    ...
    lazy val defaultInstance = org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape(
      dtype = org.tensorflow.framework.types.DataType.DT_INVALID,
      shape = _root_.scala.None
    )
    implicit class DtypeAndShapeLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape](_l) {
    ...
    ): _root_.org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape = _root_.org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape(
      dtype,
      shape
    )
  ...
  implicit class ResourceHandleProtoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.resource_handle.ResourceHandleProto]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.resource_handle.ResourceHandleProto](_l) {
    ...
    def dtypesAndShapes: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape]] = field(_.dtypesAndShapes)((c_, f_) => c_.copy(dtypesAndShapes = f_))
  }
  ...
  def of(
    ...
    maybeTypeName: _root_.scala.Predef.String,
    dtypesAndShapes: _root_.scala.Seq[org.tensorflow.framework.resource_handle.ResourceHandleProto.DtypeAndShape]
