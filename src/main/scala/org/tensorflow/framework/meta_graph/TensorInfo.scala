...
final case class TensorInfo(
    ...
    def getCompositeTensor: org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor = encoding.compositeTensor.getOrElse(org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor.defaultInstance)
    def withCompositeTensor(__v: org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor): TensorInfo = copy(encoding = org.tensorflow.framework.meta_graph.TensorInfo.Encoding.CompositeTensor(__v))
    ...
    def companion: org.tensorflow.framework.meta_graph.TensorInfo.type = org.tensorflow.framework.meta_graph.TensorInfo
...
object TensorInfo extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.TensorInfo] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.meta_graph.TensorInfo = {
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 42 =>
          __encoding = org.tensorflow.framework.meta_graph.TensorInfo.Encoding.CompositeTensor(__encoding.compositeTensor.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 16 =>
          __dtype = org.tensorflow.framework.types.DataType.fromValue(_input__.readEnum())
        case 26 =>
          __tensorShape = _root_.scala.Option(__tensorShape.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.tensor_shape.TensorShapeProto](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case tag =>
    ...
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      org.tensorflow.framework.meta_graph.TensorInfo(
        ...
        encoding = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).flatMap(_.as[_root_.scala.Option[_root_.scala.Predef.String]]).map(org.tensorflow.framework.meta_graph.TensorInfo.Encoding.Name(_))
            ...
            .orElse[org.tensorflow.framework.meta_graph.TensorInfo.Encoding](__fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).flatMap(_.as[_root_.scala.Option[org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor]]).map(org.tensorflow.framework.meta_graph.TensorInfo.Encoding.CompositeTensor(_)))
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
    ...
    (__number: @_root_.scala.unchecked) match {
      ...
      case 5 => __out = org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor
  ...
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]](
      ...
      _root_.org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor
    )
  ...
  sealed abstract class Encoding extends _root_.scalapb.GeneratedOneof {
    ...
    def compositeTensor: _root_.scala.Option[org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor] = _root_.scala.None
  }
  object Encoding {
    @SerialVersionUID(0L)
    ...
    @SerialVersionUID(0L)
    final case class CompositeTensor(value: org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor) extends org.tensorflow.framework.meta_graph.TensorInfo.Encoding {
      type ValueType = org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor
      override def isCompositeTensor: _root_.scala.Boolean = true
      override def compositeTensor: _root_.scala.Option[org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor] = Some(value)
  ...
  final case class CooSparse(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.meta_graph.TensorInfo.CooSparse.type = org.tensorflow.framework.meta_graph.TensorInfo.CooSparse
  ...
  final case class CompositeTensor(
      ...
      components: _root_.scala.Seq[org.tensorflow.framework.meta_graph.TensorInfo] = _root_.scala.Seq.empty,
      unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
      ...
      def addComponents(__vs: org.tensorflow.framework.meta_graph.TensorInfo *): CompositeTensor = addAllComponents(__vs)
      def addAllComponents(__vs: Iterable[org.tensorflow.framework.meta_graph.TensorInfo]): CompositeTensor = copy(components = components ++ __vs)
      def withComponents(__v: _root_.scala.Seq[org.tensorflow.framework.meta_graph.TensorInfo]): CompositeTensor = copy(components = __v)
      def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
      def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
      def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
        (__fieldNumber: @_root_.scala.unchecked) match {
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor.type = org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor
      // @@protoc_insertion_point(GeneratedMessage[tensorboard.TensorInfo.CompositeTensor])
  }
  
  object CompositeTensor extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor = {
      var __typeSpec: _root_.scala.Option[tensorboard.struct.TypeSpecProto] = _root_.scala.None
      val __components: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.meta_graph.TensorInfo] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.meta_graph.TensorInfo]
      var `_unknownFields__`: _root_.scalapb.UnknownFieldSet.Builder = null
      var _done__ = false
      while (!_done__) {
        val _tag__ = _input__.readTag()
        _tag__ match {
          ...
          case 18 =>
            __components += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.meta_graph.TensorInfo](_input__)
          case tag =>
            if (_unknownFields__ == null) {
              _unknownFields__ = new _root_.scalapb.UnknownFieldSet.Builder()
            }
      ...
      org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor(
          typeSpec = __typeSpec,
          components = __components.result(),
          unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
      )
    }
    implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor(
          ...
          components = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.meta_graph.TensorInfo]]).getOrElse(_root_.scala.Seq.empty)
        )
      case _ => throw new RuntimeException("Expected PMessage")
    }
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.meta_graph.TensorInfo.javaDescriptor.getNestedTypes().get(1)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.meta_graph.TensorInfo.scalaDescriptor.nestedMessages(1)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
      var __out: _root_.scalapb.GeneratedMessageCompanion[?]= null
      (__number: @_root_.scala.unchecked) match {
    ...
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
    lazy val defaultInstance = org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor(
      typeSpec = _root_.scala.None,
      components = _root_.scala.Seq.empty
    )
    implicit class CompositeTensorLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor](_l) {
      ...
      def components: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.meta_graph.TensorInfo]] = field(_.components)((c_, f_) => c_.copy(components = f_))
    }
    ...
    def of(
      ...
      components: _root_.scala.Seq[org.tensorflow.framework.meta_graph.TensorInfo]
    ): _root_.org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor = _root_.org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor(
      typeSpec,
      components
    )
  ...
  implicit class TensorInfoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.TensorInfo]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.meta_graph.TensorInfo](_l) {
    ...
    def compositeTensor: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.TensorInfo.CompositeTensor] = field(_.getCompositeTensor)((c_, f_) => c_.copy(encoding = org.tensorflow.framework.meta_graph.TensorInfo.Encoding.CompositeTensor(f_)))
    ...
    def tensorShape: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.tensor_shape.TensorShapeProto] = field(_.getTensorShape)((c_, f_) => c_.copy(tensorShape = _root_.scala.Option(f_)))
