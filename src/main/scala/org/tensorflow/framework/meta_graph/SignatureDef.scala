...
final case class SignatureDef(
    ...
    defaults: _root_.scala.collection.immutable.Map[_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto] = _root_.scala.collection.immutable.Map.empty,
    ...
    private[this] def __computeSerializedSize(): _root_.scala.Int = {
      ...
      defaults.foreach { __item =>
        val __value = org.tensorflow.framework.meta_graph.SignatureDef._typemapper_defaults.toBase(__item)
        __size += 1 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(__value.serializedSize) + __value.serializedSize
      }
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      defaults.foreach { __v =>
        val __m = org.tensorflow.framework.meta_graph.SignatureDef._typemapper_defaults.toBase(__v)
    ...
    def addDefaults(__vs: (_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto) *): SignatureDef = addAllDefaults(__vs)
    def addAllDefaults(__vs: Iterable[(_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto)]): SignatureDef = copy(defaults = defaults ++ __vs)
    def withDefaults(__v: _root_.scala.collection.immutable.Map[_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto]): SignatureDef = copy(defaults = __v)
    ...
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        ...
        case 4 => defaults.iterator.map(org.tensorflow.framework.meta_graph.SignatureDef._typemapper_defaults.toBase(_)).toSeq
      }
    }
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => _root_.scalapb.descriptors.PRepeated(defaults.iterator.map(org.tensorflow.framework.meta_graph.SignatureDef._typemapper_defaults.toBase(_).toPMessage).toVector)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: org.tensorflow.framework.meta_graph.SignatureDef.type = org.tensorflow.framework.meta_graph.SignatureDef
...
object SignatureDef extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.SignatureDef] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.meta_graph.SignatureDef = {
    ...
    val __defaults: _root_.scala.collection.mutable.Builder[(_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto), _root_.scala.collection.immutable.Map[_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto]] = _root_.scala.collection.immutable.Map.newBuilder[_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto]
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 34 =>
          __defaults += org.tensorflow.framework.meta_graph.SignatureDef._typemapper_defaults.toCustom(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry](_input__))
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.meta_graph.SignatureDef] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      org.tensorflow.framework.meta_graph.SignatureDef(
        ...
        defaults = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry]]).getOrElse(_root_.scala.Seq.empty).iterator.map(org.tensorflow.framework.meta_graph.SignatureDef._typemapper_defaults.toCustom(_)).toMap
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
    ...
    (__number: @_root_.scala.unchecked) match {
      ...
      case 4 => __out = org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]](
      ...
      _root_.org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry
    )
  ...
  final case class InputsEntry(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.meta_graph.SignatureDef.InputsEntry.type = org.tensorflow.framework.meta_graph.SignatureDef.InputsEntry
  ...
  object InputsEntry extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.SignatureDef.InputsEntry] {
    ...
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.meta_graph.SignatureDef.InputsEntry = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 18 =>
            __value = _root_.scala.Option(__value.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.meta_graph.TensorInfo](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
          case tag =>
            if (_unknownFields__ == null) {
              _unknownFields__ = new _root_.scalapb.UnknownFieldSet.Builder()
            }
    ...
    implicit class InputsEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.SignatureDef.InputsEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.meta_graph.SignatureDef.InputsEntry](_l) {
      ...
      def value: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.TensorInfo] = field(_.getValue)((c_, f_) => c_.copy(value = _root_.scala.Option(f_)))
  ...
  final case class OutputsEntry(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.meta_graph.SignatureDef.OutputsEntry.type = org.tensorflow.framework.meta_graph.SignatureDef.OutputsEntry
  ...
  final case class DefaultsEntry(
      key: _root_.scala.Predef.String = "",
      value: _root_.scala.Option[org.tensorflow.framework.tensor.TensorProto] = _root_.scala.None,
      unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
      ...
      def withValue(__v: org.tensorflow.framework.tensor.TensorProto): DefaultsEntry = copy(value = Option(__v))
      def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
      def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
      def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
        (__fieldNumber: @_root_.scala.unchecked) match {
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry.type = org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry
      // @@protoc_insertion_point(GeneratedMessage[tensorboard.SignatureDef.DefaultsEntry])
  }
  
  object DefaultsEntry extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry = {
      var __key: _root_.scala.Predef.String = ""
      var __value: _root_.scala.Option[org.tensorflow.framework.tensor.TensorProto] = _root_.scala.None
      var `_unknownFields__`: _root_.scalapb.UnknownFieldSet.Builder = null
      var _done__ = false
      while (!_done__) {
        val _tag__ = _input__.readTag()
        _tag__ match {
          ...
          case 10 =>
            __key = _input__.readStringRequireUtf8()
          case 18 =>
            __value = _root_.scala.Option(__value.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.tensor.TensorProto](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
          case tag =>
            if (_unknownFields__ == null) {
              _unknownFields__ = new _root_.scalapb.UnknownFieldSet.Builder()
            }
      ...
      org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry(
          key = __key,
          value = __value,
          unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
      )
    }
    implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry(
          key = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
          value = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).flatMap(_.as[_root_.scala.Option[org.tensorflow.framework.tensor.TensorProto]])
        )
      case _ => throw new RuntimeException("Expected PMessage")
    }
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.meta_graph.SignatureDef.javaDescriptor.getNestedTypes().get(2)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.meta_graph.SignatureDef.scalaDescriptor.nestedMessages(2)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
      var __out: _root_.scalapb.GeneratedMessageCompanion[?]= null
      (__number: @_root_.scala.unchecked) match {
    ...
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
    lazy val defaultInstance = org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry(
      key = "",
      value = _root_.scala.None
    )
    implicit class DefaultsEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry](_l) {
      def key: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.key)((c_, f_) => c_.copy(key = f_))
      def value: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.tensor.TensorProto] = field(_.getValue)((c_, f_) => c_.copy(value = _root_.scala.Option(f_)))
      def optionalValue: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[org.tensorflow.framework.tensor.TensorProto]] = field(_.value)((c_, f_) => c_.copy(value = f_))
    }
    final val KEY_FIELD_NUMBER = 1
    final val VALUE_FIELD_NUMBER = 2
    @transient
    implicit val keyValueMapper: _root_.scalapb.TypeMapper[org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry, (_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto)] =
      _root_.scalapb.TypeMapper[org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry, (_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto)](__m => (__m.key, __m.getValue))(__p => org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry(__p._1, Some(__p._2)))
    def of(
      key: _root_.scala.Predef.String,
      value: _root_.scala.Option[org.tensorflow.framework.tensor.TensorProto]
    ): _root_.org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry = _root_.org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry(
      key,
      value
    )
  ...
  implicit class SignatureDefLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.SignatureDef]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.meta_graph.SignatureDef](_l) {
    ...
    def defaults: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.collection.immutable.Map[_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto]] = field(_.defaults)((c_, f_) => c_.copy(defaults = f_))
  }
  ...
  @transient
  private[meta_graph] val _typemapper_defaults: _root_.scalapb.TypeMapper[org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry, (_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto)] = implicitly[_root_.scalapb.TypeMapper[org.tensorflow.framework.meta_graph.SignatureDef.DefaultsEntry, (_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto)]]
  def of(
    ...
    methodName: _root_.scala.Predef.String,
    defaults: _root_.scala.collection.immutable.Map[_root_.scala.Predef.String, org.tensorflow.framework.tensor.TensorProto]
