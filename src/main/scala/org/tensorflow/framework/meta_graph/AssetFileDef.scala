...
final case class AssetFileDef(
    ...
    def companion: org.tensorflow.framework.meta_graph.AssetFileDef.type = org.tensorflow.framework.meta_graph.AssetFileDef
...
object AssetFileDef extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.AssetFileDef] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.meta_graph.AssetFileDef = {
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 10 =>
          __tensorInfo = _root_.scala.Option(__tensorInfo.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.meta_graph.TensorInfo](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 18 =>
  ...
  implicit class AssetFileDefLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.AssetFileDef]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.meta_graph.AssetFileDef](_l) {
    def tensorInfo: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.TensorInfo] = field(_.getTensorInfo)((c_, f_) => c_.copy(tensorInfo = _root_.scala.Option(f_)))
