...
final case class MetaGraphDef(
    ...
    def companion: org.tensorflow.framework.meta_graph.MetaGraphDef.type = org.tensorflow.framework.meta_graph.MetaGraphDef
...
object MetaGraphDef extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.MetaGraphDef] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.meta_graph.MetaGraphDef = {
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 10 =>
          __metaInfoDef = _root_.scala.Option(__metaInfoDef.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 18 =>
          __graphDef = _root_.scala.Option(__graphDef.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.graph.GraphDef](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 26 =>
          __saverDef = _root_.scala.Option(__saverDef.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.util.saver.SaverDef](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 34 =>
  ...
  final case class MetaInfoDef(
      ...
      private[this] def __computeSerializedSize(): _root_.scala.Int = {
        ...
        functionAliases.foreach { __item =>
          val __value = org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef._typemapper_functionAliases.toBase(__item)
          __size += 1 + _root_.com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(__value.serializedSize) + __value.serializedSize
        }
        __size += unknownFields.serializedSize
        __size
      ...
      def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
        ...
        functionAliases.foreach { __v =>
          val __m = org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef._typemapper_functionAliases.toBase(__v)
      ...
      def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
        (__fieldNumber: @_root_.scala.unchecked) match {
          ...
          case 8 => functionAliases.iterator.map(org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef._typemapper_functionAliases.toBase(_)).toSeq
        }
      }
      def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
        _root_.scala.Predef.require(__field.containingMessage eq companion.scalaDescriptor)
        (__field.number: @_root_.scala.unchecked) match {
          ...
          case 8 => _root_.scalapb.descriptors.PRepeated(functionAliases.iterator.map(org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef._typemapper_functionAliases.toBase(_).toPMessage).toVector)
        }
      }
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.type = org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef
  ...
  object MetaInfoDef extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef] {
    ...
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 18 =>
            __strippedOpList = _root_.scala.Option(__strippedOpList.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.op_def.OpList](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
          case 26 =>
          ...
          case 66 =>
            __functionAliases += org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef._typemapper_functionAliases.toCustom(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry](_input__))
          case tag =>
            if (_unknownFields__ == null) {
              _unknownFields__ = new _root_.scalapb.UnknownFieldSet.Builder()
            }
    ...
    implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        ...
        org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef(
          ...
          functionAliases = __fieldsMap.get(scalaDescriptor.findFieldByNumber(8).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry]]).getOrElse(_root_.scala.Seq.empty).iterator.map(org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef._typemapper_functionAliases.toCustom(_)).toMap
        )
      case _ => throw new RuntimeException("Expected PMessage")
    }
    ...
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
      ...
      (__number: @_root_.scala.unchecked) match {
        ...
        case 8 => __out = org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry
      }
      __out
    }
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] =
      Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]](
        _root_.org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry
      )
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
    ...
    final case class FunctionAliasesEntry(
        ...
        def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
        def companion: org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry.type = org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry
        // @@protoc_insertion_point(GeneratedMessage[tensorboard.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry])
    }
    
    object FunctionAliasesEntry extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry] {
      implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry] = this
      def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry = {
        ...
        org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry(
            key = __key,
            value = __value,
            unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
        )
      }
      implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry] = _root_.scalapb.descriptors.Reads{
        case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
          _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
          org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry(
      ...
      def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.javaDescriptor.getNestedTypes().get(0)
      def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.scalaDescriptor.nestedMessages(0)
      def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= throw new MatchError(__number)
      lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
      def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
      lazy val defaultInstance = org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry(
        key = "",
        value = ""
      )
      implicit class FunctionAliasesEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry](_l) {
      ...
      @transient
      implicit val keyValueMapper: _root_.scalapb.TypeMapper[org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry, (_root_.scala.Predef.String, _root_.scala.Predef.String)] =
        _root_.scalapb.TypeMapper[org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry, (_root_.scala.Predef.String, _root_.scala.Predef.String)](__m => (__m.key, __m.value))(__p => org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry(__p._1, __p._2))
      def of(
        key: _root_.scala.Predef.String,
        value: _root_.scala.Predef.String
      ): _root_.org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry = _root_.org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry(
        key,
        value
      )
    ...
    implicit class MetaInfoDefLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef](_l) {
      ...
      def strippedOpList: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.op_def.OpList] = field(_.getStrippedOpList)((c_, f_) => c_.copy(strippedOpList = _root_.scala.Option(f_)))
    ...
    @transient
    private[meta_graph] val _typemapper_functionAliases: _root_.scalapb.TypeMapper[org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry, (_root_.scala.Predef.String, _root_.scala.Predef.String)] = implicitly[_root_.scalapb.TypeMapper[org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef.FunctionAliasesEntry, (_root_.scala.Predef.String, _root_.scala.Predef.String)]]
    def of(
      metaGraphVersion: _root_.scala.Predef.String,
  ...
  final case class CollectionDefEntry(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.meta_graph.MetaGraphDef.CollectionDefEntry.type = org.tensorflow.framework.meta_graph.MetaGraphDef.CollectionDefEntry
  ...
  object CollectionDefEntry extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.MetaGraphDef.CollectionDefEntry] {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 10 =>
            __key = _input__.readStringRequireUtf8()
          case 18 =>
            __value = _root_.scala.Option(__value.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.meta_graph.CollectionDef](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
          case tag =>
            if (_unknownFields__ == null) {
              _unknownFields__ = new _root_.scalapb.UnknownFieldSet.Builder()
            }
    ...
    implicit class CollectionDefEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.MetaGraphDef.CollectionDefEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.meta_graph.MetaGraphDef.CollectionDefEntry](_l) {
      def key: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.key)((c_, f_) => c_.copy(key = f_))
      def value: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.CollectionDef] = field(_.getValue)((c_, f_) => c_.copy(value = _root_.scala.Option(f_)))
  ...
  final case class SignatureDefEntry(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.meta_graph.MetaGraphDef.SignatureDefEntry.type = org.tensorflow.framework.meta_graph.MetaGraphDef.SignatureDefEntry
  ...
  object SignatureDefEntry extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.meta_graph.MetaGraphDef.SignatureDefEntry] {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 10 =>
            __key = _input__.readStringRequireUtf8()
          case 18 =>
            __value = _root_.scala.Option(__value.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.meta_graph.SignatureDef](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
          case tag =>
            if (_unknownFields__ == null) {
              _unknownFields__ = new _root_.scalapb.UnknownFieldSet.Builder()
            }
    ...
    implicit class SignatureDefEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.MetaGraphDef.SignatureDefEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.meta_graph.MetaGraphDef.SignatureDefEntry](_l) {
      def key: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.key)((c_, f_) => c_.copy(key = f_))
      def value: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.SignatureDef] = field(_.getValue)((c_, f_) => c_.copy(value = _root_.scala.Option(f_)))
  ...
  implicit class MetaGraphDefLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.MetaGraphDef]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.meta_graph.MetaGraphDef](_l) {
    def metaInfoDef: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.meta_graph.MetaGraphDef.MetaInfoDef] = field(_.getMetaInfoDef)((c_, f_) => c_.copy(metaInfoDef = _root_.scala.Option(f_)))
    ...
    def graphDef: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.graph.GraphDef] = field(_.getGraphDef)((c_, f_) => c_.copy(graphDef = _root_.scala.Option(f_)))
    ...
    def saverDef: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.util.saver.SaverDef] = field(_.getSaverDef)((c_, f_) => c_.copy(saverDef = _root_.scala.Option(f_)))
