...
package org.tensorflow.framework.allocation_description
...
final case class AllocationDescription(
    ...
    def companion: org.tensorflow.framework.allocation_description.AllocationDescription.type = org.tensorflow.framework.allocation_description.AllocationDescription
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.AllocationDescription])
}

object AllocationDescription extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.allocation_description.AllocationDescription] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.allocation_description.AllocationDescription] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.allocation_description.AllocationDescription = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.allocation_description.AllocationDescription] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = org.tensorflow.framework.allocation_description.AllocationDescription(
    requestedBytes = 0L,
    allocatedBytes = 0L,
    allocatorName = "",
    allocationId = 0L,
  ...
  implicit class AllocationDescriptionLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.allocation_description.AllocationDescription]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.allocation_description.AllocationDescription](_l) {
  ...
  ): _root_.org.tensorflow.framework.allocation_description.AllocationDescription = _root_.org.tensorflow.framework.allocation_description.AllocationDescription(
    requestedBytes,
    allocatedBytes,
    allocatorName,
    allocationId,
