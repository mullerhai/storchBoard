...
final case class ThreadPoolOptionProto(
    ...
    def companion: org.tensorflow.framework.config.ThreadPoolOptionProto.type = org.tensorflow.framework.config.ThreadPoolOptionProto
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.ThreadPoolOptionProto])
}

object ThreadPoolOptionProto extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.config.ThreadPoolOptionProto] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.config.ThreadPoolOptionProto] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.config.ThreadPoolOptionProto = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.config.ThreadPoolOptionProto] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = org.tensorflow.framework.config.ThreadPoolOptionProto(
    numThreads = 0,
    globalName = ""
  )
  implicit class ThreadPoolOptionProtoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.config.ThreadPoolOptionProto]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.config.ThreadPoolOptionProto](_l) {
  ...
  def of(
    ...
    globalName: _root_.scala.Predef.String
  ): _root_.org.tensorflow.framework.config.ThreadPoolOptionProto = _root_.org.tensorflow.framework.config.ThreadPoolOptionProto(
    numThreads,
    globalName
  )
