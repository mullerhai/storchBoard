...
final case class GPUOptions(
    ...
    experimental: _root_.scala.Option[org.tensorflow.framework.config.GPUOptions.Experimental] = _root_.scala.None,
    ...
    def getExperimental: org.tensorflow.framework.config.GPUOptions.Experimental = experimental.getOrElse(org.tensorflow.framework.config.GPUOptions.Experimental.defaultInstance)
    def clearExperimental: GPUOptions = copy(experimental = _root_.scala.None)
    def withExperimental(__v: org.tensorflow.framework.config.GPUOptions.Experimental): GPUOptions = copy(experimental = Option(__v))
    ...
    def companion: org.tensorflow.framework.config.GPUOptions.type = org.tensorflow.framework.config.GPUOptions
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.GPUOptions])
}

object GPUOptions extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.config.GPUOptions] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.config.GPUOptions] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.config.GPUOptions = {
    ...
    var __experimental: _root_.scala.Option[org.tensorflow.framework.config.GPUOptions.Experimental] = _root_.scala.None
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 74 =>
          __experimental = _root_.scala.Option(__experimental.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.config.GPUOptions.Experimental](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.config.GPUOptions] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      org.tensorflow.framework.config.GPUOptions(
        ...
        experimental = __fieldsMap.get(scalaDescriptor.findFieldByNumber(9).get).flatMap(_.as[_root_.scala.Option[org.tensorflow.framework.config.GPUOptions.Experimental]])
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 9 => __out = org.tensorflow.framework.config.GPUOptions.Experimental
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]](
      _root_.org.tensorflow.framework.config.GPUOptions.Experimental
    )
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
  lazy val defaultInstance = org.tensorflow.framework.config.GPUOptions(
  ...
  final case class Experimental(
      virtualDevices: _root_.scala.Seq[org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices] = _root_.scala.Seq.empty,
      ...
      streamMergeOptions: _root_.scala.Option[org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions] = _root_.scala.None,
      unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
      ...
      def addVirtualDevices(__vs: org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices *): Experimental = addAllVirtualDevices(__vs)
      def addAllVirtualDevices(__vs: Iterable[org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices]): Experimental = copy(virtualDevices = virtualDevices ++ __vs)
      def withVirtualDevices(__v: _root_.scala.Seq[org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices]): Experimental = copy(virtualDevices = __v)
      ...
      def getStreamMergeOptions: org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions = streamMergeOptions.getOrElse(org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions.defaultInstance)
      def clearStreamMergeOptions: Experimental = copy(streamMergeOptions = _root_.scala.None)
      def withStreamMergeOptions(__v: org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions): Experimental = copy(streamMergeOptions = Option(__v))
      def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
      def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
      def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
        (__fieldNumber: @_root_.scala.unchecked) match {
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.config.GPUOptions.Experimental.type = org.tensorflow.framework.config.GPUOptions.Experimental
      // @@protoc_insertion_point(GeneratedMessage[tensorboard.GPUOptions.Experimental])
  }
  
  object Experimental extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.config.GPUOptions.Experimental] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.config.GPUOptions.Experimental] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.config.GPUOptions.Experimental = {
      val __virtualDevices: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices]
      ...
      var __streamMergeOptions: _root_.scala.Option[org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions] = _root_.scala.None
      var `_unknownFields__`: _root_.scalapb.UnknownFieldSet.Builder = null
      var _done__ = false
      while (!_done__) {
        val _tag__ = _input__.readTag()
        _tag__ match {
          case 0 => _done__ = true
          case 10 =>
            __virtualDevices += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices](_input__)
          case 120 =>
          ...
          case 154 =>
            __streamMergeOptions = _root_.scala.Option(__streamMergeOptions.fold(_root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
          case tag =>
            if (_unknownFields__ == null) {
              _unknownFields__ = new _root_.scalapb.UnknownFieldSet.Builder()
            }
      ...
      org.tensorflow.framework.config.GPUOptions.Experimental(
    ...
    implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.config.GPUOptions.Experimental] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        org.tensorflow.framework.config.GPUOptions.Experimental(
          virtualDevices = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices]]).getOrElse(_root_.scala.Seq.empty),
          ...
          streamMergeOptions = __fieldsMap.get(scalaDescriptor.findFieldByNumber(19).get).flatMap(_.as[_root_.scala.Option[org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions]])
        )
      case _ => throw new RuntimeException("Expected PMessage")
    }
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.config.GPUOptions.javaDescriptor.getNestedTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.config.GPUOptions.scalaDescriptor.nestedMessages(0)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
      var __out: _root_.scalapb.GeneratedMessageCompanion[?]= null
      (__number: @_root_.scala.unchecked) match {
        case 1 => __out = org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices
        case 19 => __out = org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions
      }
      __out
    }
    lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] =
      Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]](
        _root_.org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices,
        _root_.org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions
      )
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
    lazy val defaultInstance = org.tensorflow.framework.config.GPUOptions.Experimental(
    ...
    final case class VirtualDevices(
        ...
        def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
        def companion: org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices.type = org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices
        // @@protoc_insertion_point(GeneratedMessage[tensorboard.GPUOptions.Experimental.VirtualDevices])
    }
    
    object VirtualDevices extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices] {
      implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices] = this
      def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices = {
        ...
        org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices(
      ...
      implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices] = _root_.scalapb.descriptors.Reads{
        case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
          _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
          org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices(
      ...
      def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.config.GPUOptions.Experimental.javaDescriptor.getNestedTypes().get(0)
      def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.config.GPUOptions.Experimental.scalaDescriptor.nestedMessages(0)
      def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= throw new MatchError(__number)
      lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
      def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
      lazy val defaultInstance = org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices(
        memoryLimitMb = _root_.scala.Seq.empty,
        priority = _root_.scala.Seq.empty,
        deviceOrdinal = _root_.scala.Seq.empty
      )
      implicit class VirtualDevicesLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices](_l) {
      ...
      ): _root_.org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices = _root_.org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices(
        memoryLimitMb,
        priority,
        deviceOrdinal
      )
    ...
    final case class StreamMergeOptions(
        ...
        def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
        def companion: org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions.type = org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions
        // @@protoc_insertion_point(GeneratedMessage[tensorboard.GPUOptions.Experimental.StreamMergeOptions])
    }
    
    object StreamMergeOptions extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions] {
      implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions] = this
      def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions = {
        ...
        org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions(
      ...
      implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions] = _root_.scalapb.descriptors.Reads{
        case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
          _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
          org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions(
      ...
      def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = org.tensorflow.framework.config.GPUOptions.Experimental.javaDescriptor.getNestedTypes().get(1)
      def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = org.tensorflow.framework.config.GPUOptions.Experimental.scalaDescriptor.nestedMessages(1)
      def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= throw new MatchError(__number)
      lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
      def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
      lazy val defaultInstance = org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions(
        mergeHostToDeviceStream = false,
        mergeDeviceToHostStream = false,
        mergeDeviceToDeviceStream = false
      )
      implicit class StreamMergeOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions](_l) {
      ...
      ): _root_.org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions = _root_.org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions(
    ...
    implicit class ExperimentalLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.config.GPUOptions.Experimental]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.config.GPUOptions.Experimental](_l) {
      def virtualDevices: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices]] = field(_.virtualDevices)((c_, f_) => c_.copy(virtualDevices = f_))
      ...
      def streamMergeOptions: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions] = field(_.getStreamMergeOptions)((c_, f_) => c_.copy(streamMergeOptions = _root_.scala.Option(f_)))
      def optionalStreamMergeOptions: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions]] = field(_.streamMergeOptions)((c_, f_) => c_.copy(streamMergeOptions = f_))
    }
    ...
    def of(
      virtualDevices: _root_.scala.Seq[org.tensorflow.framework.config.GPUOptions.Experimental.VirtualDevices],
      ...
      streamMergeOptions: _root_.scala.Option[org.tensorflow.framework.config.GPUOptions.Experimental.StreamMergeOptions]
    ): _root_.org.tensorflow.framework.config.GPUOptions.Experimental = _root_.org.tensorflow.framework.config.GPUOptions.Experimental(
      virtualDevices,
  ...
  implicit class GPUOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.config.GPUOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.config.GPUOptions](_l) {
    ...
    def experimental: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.config.GPUOptions.Experimental] = field(_.getExperimental)((c_, f_) => c_.copy(experimental = _root_.scala.Option(f_)))
    def optionalExperimental: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[org.tensorflow.framework.config.GPUOptions.Experimental]] = field(_.experimental)((c_, f_) => c_.copy(experimental = f_))
  }
  ...
  def of(
    ...
    experimental: _root_.scala.Option[org.tensorflow.framework.config.GPUOptions.Experimental]
  ): _root_.org.tensorflow.framework.config.GPUOptions = _root_.org.tensorflow.framework.config.GPUOptions(
