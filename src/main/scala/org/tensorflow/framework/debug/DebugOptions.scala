...
final case class DebugOptions(
    debugTensorWatchOpts: _root_.scala.Seq[org.tensorflow.framework.debug.DebugTensorWatch] = _root_.scala.Seq.empty,
    ...
    def addDebugTensorWatchOpts(__vs: org.tensorflow.framework.debug.DebugTensorWatch *): DebugOptions = addAllDebugTensorWatchOpts(__vs)
    def addAllDebugTensorWatchOpts(__vs: Iterable[org.tensorflow.framework.debug.DebugTensorWatch]): DebugOptions = copy(debugTensorWatchOpts = debugTensorWatchOpts ++ __vs)
    def withDebugTensorWatchOpts(__v: _root_.scala.Seq[org.tensorflow.framework.debug.DebugTensorWatch]): DebugOptions = copy(debugTensorWatchOpts = __v)
    ...
    def companion: org.tensorflow.framework.debug.DebugOptions.type = org.tensorflow.framework.debug.DebugOptions
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.DebugOptions])
}

object DebugOptions extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.debug.DebugOptions] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.debug.DebugOptions] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.debug.DebugOptions = {
    val __debugTensorWatchOpts: _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.debug.DebugTensorWatch] = new _root_.scala.collection.immutable.VectorBuilder[org.tensorflow.framework.debug.DebugTensorWatch]
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 34 =>
          __debugTensorWatchOpts += _root_.scalapb.LiteParser.readMessage[org.tensorflow.framework.debug.DebugTensorWatch](_input__)
        case 80 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.debug.DebugOptions] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      org.tensorflow.framework.debug.DebugOptions(
        debugTensorWatchOpts = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Seq[org.tensorflow.framework.debug.DebugTensorWatch]]).getOrElse(_root_.scala.Seq.empty),
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?]= {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 4 => __out = org.tensorflow.framework.debug.DebugTensorWatch
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?]= throw new MatchError(__fieldNumber)
  lazy val defaultInstance = org.tensorflow.framework.debug.DebugOptions(
    debugTensorWatchOpts = _root_.scala.Seq.empty,
    globalStep = 0L,
    resetDiskByteUsage = false
  )
  implicit class DebugOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.debug.DebugOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.debug.DebugOptions](_l) {
    def debugTensorWatchOpts: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[org.tensorflow.framework.debug.DebugTensorWatch]] = field(_.debugTensorWatchOpts)((c_, f_) => c_.copy(debugTensorWatchOpts = f_))
  ...
  def of(
    debugTensorWatchOpts: _root_.scala.Seq[org.tensorflow.framework.debug.DebugTensorWatch],
    globalStep: _root_.scala.Long,
    resetDiskByteUsage: _root_.scala.Boolean
  ): _root_.org.tensorflow.framework.debug.DebugOptions = _root_.org.tensorflow.framework.debug.DebugOptions(
