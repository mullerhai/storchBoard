...
final case class DebugTensorWatch(
    ...
    def companion: org.tensorflow.framework.debug.DebugTensorWatch.type = org.tensorflow.framework.debug.DebugTensorWatch
    // @@protoc_insertion_point(GeneratedMessage[tensorboard.DebugTensorWatch])
}

object DebugTensorWatch extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.debug.DebugTensorWatch] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[org.tensorflow.framework.debug.DebugTensorWatch] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): org.tensorflow.framework.debug.DebugTensorWatch = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[org.tensorflow.framework.debug.DebugTensorWatch] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = org.tensorflow.framework.debug.DebugTensorWatch(
    nodeName = "",
    outputSlot = 0,
  ...
  implicit class DebugTensorWatchLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, org.tensorflow.framework.debug.DebugTensorWatch]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, org.tensorflow.framework.debug.DebugTensorWatch](_l) {
  ...
  ): _root_.org.tensorflow.framework.debug.DebugTensorWatch = _root_.org.tensorflow.framework.debug.DebugTensorWatch(
    nodeName,
    outputSlot,
    debugOps,
    debugUrls,
