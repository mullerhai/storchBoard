...
final case class AttrValue(
    ...
    def companion: org.tensorflow.framework.attr_value.AttrValue.type = org.tensorflow.framework.attr_value.AttrValue
...
object AttrValue extends scalapb.GeneratedMessageCompanion[org.tensorflow.framework.attr_value.AttrValue] {
  ...
  final case class ListValue(
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: org.tensorflow.framework.attr_value.AttrValue.ListValue.type = org.tensorflow.framework.attr_value.AttrValue.ListValue
